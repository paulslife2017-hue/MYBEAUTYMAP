...
`);p.write(n.format.apply(n,k))}}m(w,"warn"),Object.defineProperty(t.exports,"isWin",{get:m(function(){return o},"get"),set:m(function(O){o=O},"set")}),t.exports.warnTo=function(O){var k=p;return p=O,k},t.exports.getFileName=function(O){var k=O||J.env,C=k.PGPASSFILE||(o?s.join(k.APPDATA||"./","postgresql","pgpass.conf"):s.join(k.HOME||"./",".pgpass"));return C},t.exports.usePgPass=function(O,k){return Object.prototype.hasOwnProperty.call(J.env,"PGPASSWORD")?!1:o?!0:(k=k||"<unkn>",y(O.mode)?O.mode&(f|g)?(w('WARNING: password file "%s" has group or world access; permissions should be u=rw (0600) or less',k),!1):!0:(w('WARNING: password file "%s" is not a plain file',k),!1))};var _=t.exports.match=function(O,k){return d.slice(0,-1).reduce(function(C,L,S){return S==1&&Number(O[L]||l)===Number(k[L])?C&&!0:C&&(k[L]==="*"||k[L]===O[L])},!0)};t.exports.getPassword=function(O,k,C){var L,S=k.pipe(a());function R($){var D=E($);D&&M(D)&&_(O,D)&&(L=D[v],S.end())}m(R,"onLine");var A=m(function(){k.destroy(),C(L)},"onEnd"),z=m(function($){k.destroy(),w("WARNING: error on reading file: %s",$),C(void 0)},"onErr");k.on("error",z),S.on("data",R).on("end",A).on("error",z)};var E=t.exports.parseLine=function(O){if(O.length<11||O.match(/^\s+#/))return null;for(var k="",C="",L=0,S=0,R=0,A={},z=!1,$=m(function(U,V,Y){var te=O.substring(V,Y);Object.hasOwnProperty.call(J.env,"PGPASS_NO_DEESCAPE")||(te=te.replace(/\\([:\\])/g,"$1")),A[d[U]]=te},"addToObj"),D=0;D<O.length-1;D+=1){if(k=O.charAt(D+1),C=O.charAt(D),z=L==u-1,z){$(L,S);break}D>=0&&k==":"&&C!=="\\"&&($(L,S,D+1),S=D+2,L+=1)}return A=Object.keys(A).length===u?A:null,A},M=t.exports.isValidEntry=function(O){for(var k={0:function(A){return A.length>0},1:function(A){return A==="*"?!0:(A=Number(A),isFinite(A)&&A>0&&A<9007199254740992&&Math.floor(A)===A)},2:function(A){return A.length>0},3:function(A){return A.length>0},4:function(A){return A.length>0}},C=0;C<d.length;C+=1){var L=k[C],S=O[d[C]]||"",R=L(S);if(!R)return!1}return!0}}),Ma=Z((e,t)=>{q(),Bi(),ue(ks);var s=(Ui(),ue(Ss)),i=Aa();t.exports=function(a,n){var l=i.getFileName();s.stat(l,function(o,p){if(o||!i.usePgPass(p,l))return n(void 0);var f=s.createReadStream(l);i.getPassword(a,f,n)})},t.exports.warnTo=i.warnTo}),Hi={};Se(Hi,{default:()=>Vi});var Vi,Oa=me(()=>{q(),Vi={}}),Ra=Z((e,t)=>{q();var s=(Ii(),ue(Ti)),i=(Ui(),ue(Ss));function a(n){if(n.charAt(0)==="/"){var o=n.split(" ");return{host:o[0],database:o[1]}}var l=s.parse(/ |%[^a-f0-9]|%[a-f0-9][^a-f0-9]/i.test(n)?encodeURI(n).replace(/\%25(\d\d)/g,"%$1"):n,!0),o=l.query;for(var p in o)Array.isArray(o[p])&&(o[p]=o[p][o[p].length-1]);var f=(l.auth||":").split(":");if(o.user=f[0],o.password=f.splice(1).join(":"),o.port=l.port,l.protocol=="socket:")return o.host=decodeURI(l.pathname),o.database=l.query.db,o.client_encoding=l.query.encoding,o;o.host||(o.host=l.hostname);var g=l.pathname;if(!o.host&&g&&/^%2f/i.test(g)){var x=g.split("/");o.host=decodeURIComponent(x[0]),g=x.splice(1).join("/")}switch(g&&g.charAt(0)==="/"&&(g=g.slice(1)||null),o.database=g&&decodeURI(g),(o.ssl==="true"||o.ssl==="1")&&(o.ssl=!0),o.ssl==="0"&&(o.ssl=!1),(o.sslcert||o.sslkey||o.sslrootcert||o.sslmode)&&(o.ssl={}),o.sslcert&&(o.ssl.cert=i.readFileSync(o.sslcert).toString()),o.sslkey&&(o.ssl.key=i.readFileSync(o.sslkey).toString()),o.sslrootcert&&(o.ssl.ca=i.readFileSync(o.sslrootcert).toString()),o.sslmode){case"disable":{o.ssl=!1;break}case"prefer":case"require":case"verify-ca":case"verify-full":break;case"no-verify":{o.ssl.rejectUnauthorized=!1;break}}return o}m(a,"parse"),t.exports=a,a.parse=a}),Is=Z((e,t)=>{q();var s=(Oa(),ue(Hi)),i=Jt(),a=Ra().parse,n=m(function(x,b,y){return y===void 0?y=J.env["PG"+x.toUpperCase()]:y===!1||(y=J.env[y]),b[x]||y||i[x]},"val"),l=m(function(){switch(J.env.PGSSLMODE){case"disable":return!1;case"prefer":case"require":case"verify-ca":case"verify-full":return!0;case"no-verify":return{rejectUnauthorized:!1}}return i.ssl},"readSSLConfigFromEnvironment"),o=m(function(x){return"'"+(""+x).replace(/\\/g,"\\\\").replace(/'/g,"\\'")+"'"},"quoteParamValue"),p=m(function(x,b,y){var d=b[y];d!=null&&x.push(y+"="+o(d))},"add"),f=class{constructor(b){b=typeof b=="string"?a(b):b||{},b.connectionString&&(b=Object.assign({},b,a(b.connectionString))),this.user=n("user",b),this.database=n("database",b),this.database===void 0&&(this.database=this.user),this.port=parseInt(n("port",b),10),this.host=n("host",b),Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:n("password",b)}),this.binary=n("binary",b),this.options=n("options",b),this.ssl=typeof b.ssl>"u"?l():b.ssl,typeof this.ssl=="string"&&this.ssl==="true"&&(this.ssl=!0),this.ssl==="no-verify"&&(this.ssl={rejectUnauthorized:!1}),this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this.client_encoding=n("client_encoding",b),this.replication=n("replication",b),this.isDomainSocket=!(this.host||"").indexOf("/"),this.application_name=n("application_name",b,"PGAPPNAME"),this.fallback_application_name=n("fallback_application_name",b,!1),this.statement_timeout=n("statement_timeout",b,!1),this.lock_timeout=n("lock_timeout",b,!1),this.idle_in_transaction_session_timeout=n("idle_in_transaction_session_timeout",b,!1),this.query_timeout=n("query_timeout",b,!1),b.connectionTimeoutMillis===void 0?this.connect_timeout=J.env.PGCONNECT_TIMEOUT||0:this.connect_timeout=Math.floor(b.connectionTimeoutMillis/1e3),b.keepAlive===!1?this.keepalives=0:b.keepAlive===!0&&(this.keepalives=1),typeof b.keepAliveInitialDelayMillis=="number"&&(this.keepalives_idle=Math.floor(b.keepAliveInitialDelayMillis/1e3))}getLibpqConnectionString(b){var y=[];p(y,this,"user"),p(y,this,"password"),p(y,this,"port"),p(y,this,"application_name"),p(y,this,"fallback_application_name"),p(y,this,"connect_timeout"),p(y,this,"options");var d=typeof this.ssl=="object"?this.ssl:this.ssl?{sslmode:this.ssl}:{};if(p(y,d,"sslmode"),p(y,d,"sslca"),p(y,d,"sslkey"),p(y,d,"sslcert"),p(y,d,"sslrootcert"),this.database&&y.push("dbname="+o(this.database)),this.replication&&y.push("replication="+o(this.replication)),this.host&&y.push("host="+o(this.host)),this.isDomainSocket)return b(null,y.join(" "));this.client_encoding&&y.push("client_encoding="+o(this.client_encoding)),s.lookup(this.host,function(u,v){return u?b(u,null):(y.push("hostaddr="+o(v)),b(null,y.join(" ")))})}};m(f,"ConnectionParameters");var g=f;t.exports=g}),Na=Z((e,t)=>{q();var s=Kt(),i=/^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/,a=class{constructor(o,p){this.command=null,this.rowCount=null,this.oid=null,this.rows=[],this.fields=[],this._parsers=void 0,this._types=p,this.RowCtor=null,this.rowAsArray=o==="array",this.rowAsArray&&(this.parseRow=this._parseRowAsArray)}addCommandComplete(o){var p;o.text?p=i.exec(o.text):p=i.exec(o.command),p&&(this.command=p[1],p[3]?(this.oid=parseInt(p[2],10),this.rowCount=parseInt(p[3],10)):p[2]&&(this.rowCount=parseInt(p[2],10)))}_parseRowAsArray(o){for(var p=new Array(o.length),f=0,g=o.length;f<g;f++){var x=o[f];x!==null?p[f]=this._parsers[f](x):p[f]=null}return p}parseRow(o){for(var p={},f=0,g=o.length;f<g;f++){var x=o[f],b=this.fields[f].name;x!==null?p[b]=this._parsers[f](x):p[b]=null}return p}addRow(o){this.rows.push(o)}addFields(o){this.fields=o,this.fields.length&&(this._parsers=new Array(o.length));for(var p=0;p<o.length;p++){var f=o[p];this._types?this._parsers[p]=this._types.getTypeParser(f.dataTypeID,f.format||"text"):this._parsers[p]=s.getTypeParser(f.dataTypeID,f.format||"text")}}};m(a,"Result");var n=a;t.exports=n}),Da=Z((e,t)=>{q();var{EventEmitter:s}=Xe(),i=Na(),a=Zt(),n=class extends s{constructor(p,f,g){super(),p=a.normalizeQueryConfig(p,f,g),this.text=p.text,this.values=p.values,this.rows=p.rows,this.types=p.types,this.name=p.name,this.binary=p.binary,this.portal=p.portal||"",this.callback=p.callback,this._rowMode=p.rowMode,J.domain&&p.callback&&(this.callback=J.domain.bind(p.callback)),this._result=new i(this._rowMode,this.types),this._results=this._result,this.isPreparedStatement=!1,this._canceledDueToError=!1,this._promise=null}requiresPreparation(){return this.name||this.rows?!0:!this.text||!this.values?!1:this.values.length>0}_checkForMultirow(){this._result.command&&(Array.isArray(this._results)||(this._results=[this._result]),this._result=new i(this._rowMode,this.types),this._results.push(this._result))}handleRowDescription(p){this._checkForMultirow(),this._result.addFields(p.fields),this._accumulateRows=this.callback||!this.listeners("row").length}handleDataRow(p){let f;if(!this._canceledDueToError){try{f=this._result.parseRow(p.fields)}catch(g){this._canceledDueToError=g;return}this.emit("row",f,this._result),this._accumulateRows&&this._result.addRow(f)}}handleCommandComplete(p,f){this._checkForMultirow(),this._result.addCommandComplete(p),this.rows&&f.sync()}handleEmptyQuery(p){this.rows&&p.sync()}handleError(p,f){if(this._canceledDueToError&&(p=this._canceledDueToError,this._canceledDueToError=!1),this.callback)return this.callback(p);this.emit("error",p)}handleReadyForQuery(p){if(this._canceledDueToError)return this.handleError(this._canceledDueToError,p);if(this.callback)try{this.callback(null,this._results)}catch(f){J.nextTick(()=>{throw f})}this.emit("end",this._results)}submit(p){if(typeof this.text!="string"&&typeof this.name!="string")return new Error("A query must have either text or a name. Supplying neither is unsupported.");let f=p.parsedStatements[this.name];return this.text&&f&&this.text!==f?new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`):this.values&&!Array.isArray(this.values)?new Error("Query values must be an array"):(this.requiresPreparation()?this.prepare(p):p.query(this.text),null)}hasBeenParsed(p){return this.name&&p.parsedStatements[this.name]}handlePortalSuspended(p){this._getRows(p,this.rows)}_getRows(p,f){p.execute({portal:this.portal,rows:f}),f?p.flush():p.sync()}prepare(p){this.isPreparedStatement=!0,this.hasBeenParsed(p)||p.parse({text:this.text,name:this.name,types:this.types});try{p.bind({portal:this.portal,statement:this.name,values:this.values,binary:this.binary,valueMapper:a.prepareValue})}catch(f){this.handleError(f,p);return}p.describe({type:"P",name:this.portal||""}),this._getRows(p,this.rows)}handleCopyInResponse(p){p.sendCopyFail("No source stream defined")}handleCopyData(p,f){}};m(n,"Query");var l=n;t.exports=l}),Wi=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.NoticeMessage=e.DataRowMessage=e.CommandCompleteMessage=e.ReadyForQueryMessage=e.NotificationResponseMessage=e.BackendKeyDataMessage=e.AuthenticationMD5Password=e.ParameterStatusMessage=e.ParameterDescriptionMessage=e.RowDescriptionMessage=e.Field=e.CopyResponse=e.CopyDataMessage=e.DatabaseError=e.copyDone=e.emptyQuery=e.replicationStart=e.portalSuspended=e.noData=e.closeComplete=e.bindComplete=e.parseComplete=void 0,e.parseComplete={name:"parseComplete",length:5},e.bindComplete={name:"bindComplete",length:5},e.closeComplete={name:"closeComplete",length:5},e.noData={name:"noData",length:5},e.portalSuspended={name:"portalSuspended",length:5},e.replicationStart={name:"replicationStart",length:4},e.emptyQuery={name:"emptyQuery",length:4},e.copyDone={name:"copyDone",length:4};var t=class extends Error{constructor(D,U,V){super(D),this.length=U,this.name=V}};m(t,"DatabaseError");var s=t;e.DatabaseError=s;var i=class{constructor(D,U){this.length=D,this.chunk=U,this.name="copyData"}};m(i,"CopyDataMessage");var a=i;e.CopyDataMessage=a;var n=class{constructor(D,U,V,Y){this.length=D,this.name=U,this.binary=V,this.columnTypes=new Array(Y)}};m(n,"CopyResponse");var l=n;e.CopyResponse=l;var o=class{constructor(D,U,V,Y,te,K,be){this.name=D,this.tableID=U,this.columnID=V,this.dataTypeID=Y,this.dataTypeSize=te,this.dataTypeModifier=K,this.format=be}};m(o,"Field");var p=o;e.Field=p;var f=class{constructor(D,U){this.length=D,this.fieldCount=U,this.name="rowDescription",this.fields=new Array(this.fieldCount)}};m(f,"RowDescriptionMessage");var g=f;e.RowDescriptionMessage=g;var x=class{constructor(D,U){this.length=D,this.parameterCount=U,this.name="parameterDescription",this.dataTypeIDs=new Array(this.parameterCount)}};m(x,"ParameterDescriptionMessage");var b=x;e.ParameterDescriptionMessage=b;var y=class{constructor(D,U,V){this.length=D,this.parameterName=U,this.parameterValue=V,this.name="parameterStatus"}};m(y,"ParameterStatusMessage");var d=y;e.ParameterStatusMessage=d;var u=class{constructor(D,U){this.length=D,this.salt=U,this.name="authenticationMD5Password"}};m(u,"AuthenticationMD5Password");var v=u;e.AuthenticationMD5Password=v;var w=class{constructor(D,U,V){this.length=D,this.processID=U,this.secretKey=V,this.name="backendKeyData"}};m(w,"BackendKeyDataMessage");var _=w;e.BackendKeyDataMessage=_;var E=class{constructor(D,U,V,Y){this.length=D,this.processId=U,this.channel=V,this.payload=Y,this.name="notification"}};m(E,"NotificationResponseMessage");var M=E;e.NotificationResponseMessage=M;var O=class{constructor(D,U){this.length=D,this.status=U,this.name="readyForQuery"}};m(O,"ReadyForQueryMessage");var k=O;e.ReadyForQueryMessage=k;var C=class{constructor(D,U){this.length=D,this.text=U,this.name="commandComplete"}};m(C,"CommandCompleteMessage");var L=C;e.CommandCompleteMessage=L;var S=class{constructor(D,U){this.length=D,this.fields=U,this.name="dataRow",this.fieldCount=U.length}};m(S,"DataRowMessage");var R=S;e.DataRowMessage=R;var A=class{constructor(D,U){this.length=D,this.message=U,this.name="notice"}};m(A,"NoticeMessage");var z=A;e.NoticeMessage=z}),Pa=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.Writer=void 0;var t=class{constructor(a=256){this.size=a,this.offset=5,this.headerPosition=0,this.buffer=W.allocUnsafe(a)}ensure(a){if(this.buffer.length-this.offset<a){let n=this.buffer,l=n.length+(n.length>>1)+a;this.buffer=W.allocUnsafe(l),n.copy(this.buffer)}}addInt32(a){return this.ensure(4),this.buffer[this.offset++]=a>>>24&255,this.buffer[this.offset++]=a>>>16&255,this.buffer[this.offset++]=a>>>8&255,this.buffer[this.offset++]=a>>>0&255,this}addInt16(a){return this.ensure(2),this.buffer[this.offset++]=a>>>8&255,this.buffer[this.offset++]=a>>>0&255,this}addCString(a){if(!a)this.ensure(1);else{let n=W.byteLength(a);this.ensure(n+1),this.buffer.write(a,this.offset,"utf-8"),this.offset+=n}return this.buffer[this.offset++]=0,this}addString(a=""){let n=W.byteLength(a);return this.ensure(n),this.buffer.write(a,this.offset),this.offset+=n,this}add(a){return this.ensure(a.length),a.copy(this.buffer,this.offset),this.offset+=a.length,this}join(a){if(a){this.buffer[this.headerPosition]=a;let n=this.offset-(this.headerPosition+1);this.buffer.writeInt32BE(n,this.headerPosition+1)}return this.buffer.slice(a?0:5,this.offset)}flush(a){let n=this.join(a);return this.offset=5,this.headerPosition=0,this.buffer=W.allocUnsafe(this.size),n}};m(t,"Writer");var s=t;e.Writer=s}),Ba=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.serialize=void 0;var t=Pa(),s=new t.Writer,i=m(D=>{s.addInt16(3).addInt16(0);for(let Y of Object.keys(D))s.addCString(Y).addCString(D[Y]);s.addCString("client_encoding").addCString("UTF8");let U=s.addCString("").flush(),V=U.length+4;return new t.Writer().addInt32(V).add(U).flush()},"startup"),a=m(()=>{let D=W.allocUnsafe(8);return D.writeInt32BE(8,0),D.writeInt32BE(80877103,4),D},"requestSsl"),n=m(D=>s.addCString(D).flush(112),"password"),l=m(function(D,U){return s.addCString(D).addInt32(W.byteLength(U)).addString(U),s.flush(112)},"sendSASLInitialResponseMessage"),o=m(function(D){return s.addString(D).flush(112)},"sendSCRAMClientFinalMessage"),p=m(D=>s.addCString(D).flush(81),"query"),f=[],g=m(D=>{let U=D.name||"";U.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",U,U.length),console.error("This can cause conflicts and silent errors executing queries"));let V=D.types||f,Y=V.length,te=s.addCString(U).addCString(D.text).addInt16(Y);for(let K=0;K<Y;K++)te.addInt32(V[K]);return s.flush(80)},"parse"),x=new t.Writer,b=m(function(D,U){for(let V=0;V<D.length;V++){let Y=U?U(D[V],V):D[V];Y==null?(s.addInt16(0),x.addInt32(-1)):Y instanceof W?(s.addInt16(1),x.addInt32(Y.length),x.add(Y)):(s.addInt16(0),x.addInt32(W.byteLength(Y)),x.addString(Y))}},"writeValues"),y=m((D={})=>{let U=D.portal||"",V=D.statement||"",Y=D.binary||!1,te=D.values||f,K=te.length;return s.addCString(U).addCString(V),s.addInt16(K),b(te,D.valueMapper),s.addInt16(K),s.add(x.flush()),s.addInt16(Y?1:0),s.flush(66)},"bind"),d=W.from([69,0,0,0,9,0,0,0,0,0]),u=m(D=>{if(!D||!D.portal&&!D.rows)return d;let U=D.portal||"",V=D.rows||0,Y=W.byteLength(U),te=4+Y+1+4,K=W.allocUnsafe(1+te);return K[0]=69,K.writeInt32BE(te,1),K.write(U,5,"utf-8"),K[Y+5]=0,K.writeUInt32BE(V,K.length-4),K},"execute"),v=m((D,U)=>{let V=W.allocUnsafe(16);return V.writeInt32BE(16,0),V.writeInt16BE(1234,4),V.writeInt16BE(5678,6),V.writeInt32BE(D,8),V.writeInt32BE(U,12),V},"cancel"),w=m((D,U)=>{let V=4+W.byteLength(U)+1,Y=W.allocUnsafe(1+V);return Y[0]=D,Y.writeInt32BE(V,1),Y.write(U,5,"utf-8"),Y[V]=0,Y},"cstringMessage"),_=s.addCString("P").flush(68),E=s.addCString("S").flush(68),M=m(D=>D.name?w(68,`${D.type}${D.name||""}`):D.type==="P"?_:E,"describe"),O=m(D=>{let U=`${D.type}${D.name||""}`;return w(67,U)},"close"),k=m(D=>s.add(D).flush(100),"copyData"),C=m(D=>w(102,D),"copyFail"),L=m(D=>W.from([D,0,0,0,4]),"codeOnlyBuffer"),S=L(72),R=L(83),A=L(88),z=L(99),$={startup:i,password:n,requestSsl:a,sendSASLInitialResponseMessage:l,sendSCRAMClientFinalMessage:o,query:p,parse:g,bind:y,execute:u,describe:M,close:O,flush:m(()=>S,"flush"),sync:m(()=>R,"sync"),end:m(()=>A,"end"),copyData:k,copyDone:m(()=>z,"copyDone"),copyFail:C,cancel:v};e.serialize=$}),Fa=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.BufferReader=void 0;var t=W.allocUnsafe(0),s=class{constructor(n=0){this.offset=n,this.buffer=t,this.encoding="utf-8"}setBuffer(n,l){this.offset=n,this.buffer=l}int16(){let n=this.buffer.readInt16BE(this.offset);return this.offset+=2,n}byte(){let n=this.buffer[this.offset];return this.offset++,n}int32(){let n=this.buffer.readInt32BE(this.offset);return this.offset+=4,n}uint32(){let n=this.buffer.readUInt32BE(this.offset);return this.offset+=4,n}string(n){let l=this.buffer.toString(this.encoding,this.offset,this.offset+n);return this.offset+=n,l}cstring(){let n=this.offset,l=n;for(;this.buffer[l++]!==0;);return this.offset=l,this.buffer.toString(this.encoding,n,l-1)}bytes(n){let l=this.buffer.slice(this.offset,this.offset+n);return this.offset+=n,l}};m(s,"BufferReader");var i=s;e.BufferReader=i}),Ua=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.Parser=void 0;var t=Wi(),s=Fa(),i=1,a=4,n=i+a,l=W.allocUnsafe(0),o=class{constructor(g){if(this.buffer=l,this.bufferLength=0,this.bufferOffset=0,this.reader=new s.BufferReader,(g==null?void 0:g.mode)==="binary")throw new Error("Binary mode not supported yet");this.mode=(g==null?void 0:g.mode)||"text"}parse(g,x){this.mergeBuffer(g);let b=this.bufferOffset+this.bufferLength,y=this.bufferOffset;for(;y+n<=b;){let d=this.buffer[y],u=this.buffer.readUInt32BE(y+i),v=i+u;if(v+y<=b){let w=this.handlePacket(y+n,d,u,this.buffer);x(w),y+=v}else break}y===b?(this.buffer=l,this.bufferLength=0,this.bufferOffset=0):(this.bufferLength=b-y,this.bufferOffset=y)}mergeBuffer(g){if(this.bufferLength>0){let x=this.bufferLength+g.byteLength;if(x+this.bufferOffset>this.buffer.byteLength){let b;if(x<=this.buffer.byteLength&&this.bufferOffset>=this.bufferLength)b=this.buffer;else{let y=this.buffer.byteLength*2;for(;x>=y;)y*=2;b=W.allocUnsafe(y)}this.buffer.copy(b,0,this.bufferOffset,this.bufferOffset+this.bufferLength),this.buffer=b,this.bufferOffset=0}g.copy(this.buffer,this.bufferOffset+this.bufferLength),this.bufferLength=x}else this.buffer=g,this.bufferOffset=0,this.bufferLength=g.byteLength}handlePacket(g,x,b,y){switch(x){case 50:return t.bindComplete;case 49:return t.parseComplete;case 51:return t.closeComplete;case 110:return t.noData;case 115:return t.portalSuspended;case 99:return t.copyDone;case 87:return t.replicationStart;case 73:return t.emptyQuery;case 68:return this.parseDataRowMessage(g,b,y);case 67:return this.parseCommandCompleteMessage(g,b,y);case 90:return this.parseReadyForQueryMessage(g,b,y);case 65:return this.parseNotificationMessage(g,b,y);case 82:return this.parseAuthenticationResponse(g,b,y);case 83:return this.parseParameterStatusMessage(g,b,y);case 75:return this.parseBackendKeyData(g,b,y);case 69:return this.parseErrorMessage(g,b,y,"error");case 78:return this.parseErrorMessage(g,b,y,"notice");case 84:return this.parseRowDescriptionMessage(g,b,y);case 116:return this.parseParameterDescriptionMessage(g,b,y);case 71:return this.parseCopyInMessage(g,b,y);case 72:return this.parseCopyOutMessage(g,b,y);case 100:return this.parseCopyData(g,b,y);default:return new t.DatabaseError("received invalid response: "+x.toString(16),b,"error")}}parseReadyForQueryMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.string(1);return new t.ReadyForQueryMessage(x,y)}parseCommandCompleteMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.cstring();return new t.CommandCompleteMessage(x,y)}parseCopyData(g,x,b){let y=b.slice(g,g+(x-4));return new t.CopyDataMessage(x,y)}parseCopyInMessage(g,x,b){return this.parseCopyMessage(g,x,b,"copyInResponse")}parseCopyOutMessage(g,x,b){return this.parseCopyMessage(g,x,b,"copyOutResponse")}parseCopyMessage(g,x,b,y){this.reader.setBuffer(g,b);let d=this.reader.byte()!==0,u=this.reader.int16(),v=new t.CopyResponse(x,y,d,u);for(let w=0;w<u;w++)v.columnTypes[w]=this.reader.int16();return v}parseNotificationMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int32(),d=this.reader.cstring(),u=this.reader.cstring();return new t.NotificationResponseMessage(x,y,d,u)}parseRowDescriptionMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int16(),d=new t.RowDescriptionMessage(x,y);for(let u=0;u<y;u++)d.fields[u]=this.parseField();return d}parseField(){let g=this.reader.cstring(),x=this.reader.uint32(),b=this.reader.int16(),y=this.reader.uint32(),d=this.reader.int16(),u=this.reader.int32(),v=this.reader.int16()===0?"text":"binary";return new t.Field(g,x,b,y,d,u,v)}parseParameterDescriptionMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int16(),d=new t.ParameterDescriptionMessage(x,y);for(let u=0;u<y;u++)d.dataTypeIDs[u]=this.reader.int32();return d}parseDataRowMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int16(),d=new Array(y);for(let u=0;u<y;u++){let v=this.reader.int32();d[u]=v===-1?null:this.reader.string(v)}return new t.DataRowMessage(x,d)}parseParameterStatusMessage(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.cstring(),d=this.reader.cstring();return new t.ParameterStatusMessage(x,y,d)}parseBackendKeyData(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int32(),d=this.reader.int32();return new t.BackendKeyDataMessage(x,y,d)}parseAuthenticationResponse(g,x,b){this.reader.setBuffer(g,b);let y=this.reader.int32(),d={name:"authenticationOk",length:x};switch(y){case 0:break;case 3:d.length===8&&(d.name="authenticationCleartextPassword");break;case 5:if(d.length===12){d.name="authenticationMD5Password";let u=this.reader.bytes(4);return new t.AuthenticationMD5Password(x,u)}break;case 10:{d.name="authenticationSASL",d.mechanisms=[];let u;do u=this.reader.cstring(),u&&d.mechanisms.push(u);while(u)}break;case 11:d.name="authenticationSASLContinue",d.data=this.reader.string(x-8);break;case 12:d.name="authenticationSASLFinal",d.data=this.reader.string(x-8);break;default:throw new Error("Unknown authenticationOk message type "+y)}return d}parseErrorMessage(g,x,b,y){this.reader.setBuffer(g,b);let d={},u=this.reader.string(1);for(;u!=="\0";)d[u]=this.reader.cstring(),u=this.reader.string(1);let v=d.M,w=y==="notice"?new t.NoticeMessage(x,v):new t.DatabaseError(v,x,y);return w.severity=d.S,w.code=d.C,w.detail=d.D,w.hint=d.H,w.position=d.P,w.internalPosition=d.p,w.internalQuery=d.q,w.where=d.W,w.schema=d.s,w.table=d.t,w.column=d.c,w.dataType=d.d,w.constraint=d.n,w.file=d.F,w.line=d.L,w.routine=d.R,w}};m(o,"Parser");var p=o;e.Parser=p}),Gi=Z(e=>{q(),Object.defineProperty(e,"__esModule",{value:!0}),e.DatabaseError=e.serialize=e.parse=void 0;var t=Wi();Object.defineProperty(e,"DatabaseError",{enumerable:!0,get:m(function(){return t.DatabaseError},"get")});var s=Ba();Object.defineProperty(e,"serialize",{enumerable:!0,get:m(function(){return s.serialize},"get")});var i=Ua();function a(n,l){let o=new i.Parser;return n.on("data",p=>o.parse(p,l)),new Promise(p=>n.on("end",()=>p()))}m(a,"parse"),e.parse=a}),Qi={};Se(Qi,{connect:()=>Yi});function Yi({socket:e,servername:t}){return e.startTls(t),e}var za=me(()=>{q(),m(Yi,"connect")}),Xi=Z((e,t)=>{q();var s=(Mt(),ue(ki)),i=Xe().EventEmitter,{parse:a,serialize:n}=Gi(),l=n.flush(),o=n.sync(),p=n.end(),f=class extends i{constructor(b){super(),b=b||{},this.stream=b.stream||new s.Socket,this._keepAlive=b.keepAlive,this._keepAliveInitialDelayMillis=b.keepAliveInitialDelayMillis,this.lastBuffer=!1,this.parsedStatements={},this.ssl=b.ssl||!1,this._ending=!1,this._emitMessage=!1;var y=this;this.on("newListener",function(d){d==="message"&&(y._emitMessage=!0)})}connect(b,y){var d=this;this._connecting=!0,this.stream.setNoDelay(!0),this.stream.connect(b,y),this.stream.once("connect",function(){d._keepAlive&&d.stream.setKeepAlive(!0,d._keepAliveInitialDelayMillis),d.emit("connect")});let u=m(function(v){d._ending&&(v.code==="ECONNRESET"||v.code==="EPIPE")||d.emit("error",v)},"reportStreamError");if(this.stream.on("error",u),this.stream.on("close",function(){d.emit("end")}),!this.ssl)return this.attachListeners(this.stream);this.stream.once("data",function(v){var w=v.toString("utf8");switch(w){case"S":break;case"N":return d.stream.end(),d.emit("error",new Error("The server does not support SSL connections"));default:return d.stream.end(),d.emit("error",new Error("There was an error establishing an SSL connection"))}var _=(za(),ue(Qi));let E={socket:d.stream};d.ssl!==!0&&(Object.assign(E,d.ssl),"key"in d.ssl&&(E.key=d.ssl.key)),s.isIP(y)===0&&(E.servername=y);try{d.stream=_.connect(E)}catch(M){return d.emit("error",M)}d.attachListeners(d.stream),d.stream.on("error",u),d.emit("sslconnect")})}attachListeners(b){b.on("end",()=>{this.emit("end")}),a(b,y=>{var d=y.name==="error"?"errorMessage":y.name;this._emitMessage&&this.emit("message",y),this.emit(d,y)})}requestSsl(){this.stream.write(n.requestSsl())}startup(b){this.stream.write(n.startup(b))}cancel(b,y){this._send(n.cancel(b,y))}password(b){this._send(n.password(b))}sendSASLInitialResponseMessage(b,y){this._send(n.sendSASLInitialResponseMessage(b,y))}sendSCRAMClientFinalMessage(b){this._send(n.sendSCRAMClientFinalMessage(b))}_send(b){return this.stream.writable?this.stream.write(b):!1}query(b){this._send(n.query(b))}parse(b){this._send(n.parse(b))}bind(b){this._send(n.bind(b))}execute(b){this._send(n.execute(b))}flush(){this.stream.writable&&this.stream.write(l)}sync(){this._ending=!0,this._send(l),this._send(o)}ref(){this.stream.ref()}unref(){this.stream.unref()}end(){if(this._ending=!0,!this._connecting||!this.stream.writable){this.stream.end();return}return this.stream.write(p,()=>{this.stream.end()})}close(b){this._send(n.close(b))}describe(b){this._send(n.describe(b))}sendCopyFromChunk(b){this._send(n.copyData(b))}endCopyFrom(){this._send(n.copyDone())}sendCopyFail(b){this._send(n.copyFail(b))}};m(f,"Connection");var g=f;t.exports=g}),ja=Z((e,t)=>{q();var s=Xe().EventEmitter;es(),ue(Ot);var i=Zt(),a=Ia(),n=Ma(),l=_s(),o=Is(),p=Da(),f=Jt(),g=Xi(),x=class extends s{constructor(d){super(),this.connectionParameters=new o(d),this.user=this.connectionParameters.user,this.database=this.connectionParameters.database,this.port=this.connectionParameters.port,this.host=this.connectionParameters.host,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:this.connectionParameters.password}),this.replication=this.connectionParameters.replication;var u=d||{};this._Promise=u.Promise||Xt.Promise,this._types=new l(u.types),this._ending=!1,this._connecting=!1,this._connected=!1,this._connectionError=!1,this._queryable=!0,this.connection=u.connection||new g({stream:u.stream,ssl:this.connectionParameters.ssl,keepAlive:u.keepAlive||!1,keepAliveInitialDelayMillis:u.keepAliveInitialDelayMillis||0,encoding:this.connectionParameters.client_encoding||"utf8"}),this.queryQueue=[],this.binary=u.binary||f.binary,this.processID=null,this.secretKey=null,this.ssl=this.connectionParameters.ssl||!1,this.ssl&&this.ssl.key&&Object.defineProperty(this.ssl,"key",{enumerable:!1}),this._connectionTimeoutMillis=u.connectionTimeoutMillis||0}_errorAllQueries(d){let u=m(v=>{J.nextTick(()=>{v.handleError(d,this.connection)})},"enqueueError");this.activeQuery&&(u(this.activeQuery),this.activeQuery=null),this.queryQueue.forEach(u),this.queryQueue.length=0}_connect(d){var u=this,v=this.connection;if(this._connectionCallback=d,this._connecting||this._connected){let w=new Error("Client has already been connected. You cannot reuse a client.");J.nextTick(()=>{d(w)});return}this._connecting=!0,this.connectionTimeoutHandle,this._connectionTimeoutMillis>0&&(this.connectionTimeoutHandle=setTimeout(()=>{v._ending=!0,v.stream.destroy(new Error("timeout expired"))},this._connectionTimeoutMillis)),this.host&&this.host.indexOf("/")===0?v.connect(this.host+"/.s.PGSQL."+this.port):v.connect(this.port,this.host),v.on("connect",function(){u.ssl?v.requestSsl():v.startup(u.getStartupConf())}),v.on("sslconnect",function(){v.startup(u.getStartupConf())}),this._attachListeners(v),v.once("end",()=>{let w=this._ending?new Error("Connection terminated"):new Error("Connection terminated unexpectedly");clearTimeout(this.connectionTimeoutHandle),this._errorAllQueries(w),this._ending||(this._connecting&&!this._connectionError?this._connectionCallback?this._connectionCallback(w):this._handleErrorEvent(w):this._connectionError||this._handleErrorEvent(w)),J.nextTick(()=>{this.emit("end")})})}connect(d){if(d){this._connect(d);return}return new this._Promise((u,v)=>{this._connect(w=>{w?v(w):u()})})}_attachListeners(d){d.on("authenticationCleartextPassword",this._handleAuthCleartextPassword.bind(this)),d.on("authenticationMD5Password",this._handleAuthMD5Password.bind(this)),d.on("authenticationSASL",this._handleAuthSASL.bind(this)),d.on("authenticationSASLContinue",this._handleAuthSASLContinue.bind(this)),d.on("authenticationSASLFinal",this._handleAuthSASLFinal.bind(this)),d.on("backendKeyData",this._handleBackendKeyData.bind(this)),d.on("error",this._handleErrorEvent.bind(this)),d.on("errorMessage",this._handleErrorMessage.bind(this)),d.on("readyForQuery",this._handleReadyForQuery.bind(this)),d.on("notice",this._handleNotice.bind(this)),d.on("rowDescription",this._handleRowDescription.bind(this)),d.on("dataRow",this._handleDataRow.bind(this)),d.on("portalSuspended",this._handlePortalSuspended.bind(this)),d.on("emptyQuery",this._handleEmptyQuery.bind(this)),d.on("commandComplete",this._handleCommandComplete.bind(this)),d.on("parseComplete",this._handleParseComplete.bind(this)),d.on("copyInResponse",this._handleCopyInResponse.bind(this)),d.on("copyData",this._handleCopyData.bind(this)),d.on("notification",this._handleNotification.bind(this))}_checkPgPass(d){let u=this.connection;typeof this.password=="function"?this._Promise.resolve().then(()=>this.password()).then(v=>{if(v!==void 0){if(typeof v!="string"){u.emit("error",new TypeError("Password must be a string"));return}this.connectionParameters.password=this.password=v}else this.connectionParameters.password=this.password=null;d()}).catch(v=>{u.emit("error",v)}):this.password!==null?d():n(this.connectionParameters,v=>{v!==void 0&&(this.connectionParameters.password=this.password=v),d()})}_handleAuthCleartextPassword(d){this._checkPgPass(()=>{this.connection.password(this.password)})}_handleAuthMD5Password(d){this._checkPgPass(()=>{let u=i.postgresMd5PasswordHash(this.user,this.password,d.salt);this.connection.password(u)})}_handleAuthSASL(d){this._checkPgPass(()=>{this.saslSession=a.startSession(d.mechanisms),this.connection.sendSASLInitialResponseMessage(this.saslSession.mechanism,this.saslSession.response)})}_handleAuthSASLContinue(d){a.continueSession(this.saslSession,this.password,d.data),this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}_handleAuthSASLFinal(d){a.finalizeSession(this.saslSession,d.data),this.saslSession=null}_handleBackendKeyData(d){this.processID=d.processID,this.secretKey=d.secretKey}_handleReadyForQuery(d){this._connecting&&(this._connecting=!1,this._connected=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback&&(this._connectionCallback(null,this),this._connectionCallback=null),this.emit("connect"));let{activeQuery:u}=this;this.activeQuery=null,this.readyForQuery=!0,u&&u.handleReadyForQuery(this.connection),this._pulseQueryQueue()}_handleErrorWhileConnecting(d){if(!this._connectionError){if(this._connectionError=!0,clearTimeout(this.connectionTimeoutHandle),this._connectionCallback)return this._connectionCallback(d);this.emit("error",d)}}_handleErrorEvent(d){if(this._connecting)return this._handleErrorWhileConnecting(d);this._queryable=!1,this._errorAllQueries(d),this.emit("error",d)}_handleErrorMessage(d){if(this._connecting)return this._handleErrorWhileConnecting(d);let u=this.activeQuery;if(!u){this._handleErrorEvent(d);return}this.activeQuery=null,u.handleError(d,this.connection)}_handleRowDescription(d){this.activeQuery.handleRowDescription(d)}_handleDataRow(d){this.activeQuery.handleDataRow(d)}_handlePortalSuspended(d){this.activeQuery.handlePortalSuspended(this.connection)}_handleEmptyQuery(d){this.activeQuery.handleEmptyQuery(this.connection)}_handleCommandComplete(d){this.activeQuery.handleCommandComplete(d,this.connection)}_handleParseComplete(d){this.activeQuery.name&&(this.connection.parsedStatements[this.activeQuery.name]=this.activeQuery.text)}_handleCopyInResponse(d){this.activeQuery.handleCopyInResponse(this.connection)}_handleCopyData(d){this.activeQuery.handleCopyData(d,this.connection)}_handleNotification(d){this.emit("notification",d)}_handleNotice(d){this.emit("notice",d)}getStartupConf(){var d=this.connectionParameters,u={user:d.user,database:d.database},v=d.application_name||d.fallback_application_name;return v&&(u.application_name=v),d.replication&&(u.replication=""+d.replication),d.statement_timeout&&(u.statement_timeout=String(parseInt(d.statement_timeout,10))),d.lock_timeout&&(u.lock_timeout=String(parseInt(d.lock_timeout,10))),d.idle_in_transaction_session_timeout&&(u.idle_in_transaction_session_timeout=String(parseInt(d.idle_in_transaction_session_timeout,10))),d.options&&(u.options=d.options),u}cancel(d,u){if(d.activeQuery===u){var v=this.connection;this.host&&this.host.indexOf("/")===0?v.connect(this.host+"/.s.PGSQL."+this.port):v.connect(this.port,this.host),v.on("connect",function(){v.cancel(d.processID,d.secretKey)})}else d.queryQueue.indexOf(u)!==-1&&d.queryQueue.splice(d.queryQueue.indexOf(u),1)}setTypeParser(d,u,v){return this._types.setTypeParser(d,u,v)}getTypeParser(d,u){return this._types.getTypeParser(d,u)}escapeIdentifier(d){return'"'+d.replace(/"/g,'""')+'"'}escapeLiteral(d){for(var u=!1,v="'",w=0;w<d.length;w++){var _=d[w];_==="'"?v+=_+_:_==="\\"?(v+=_+_,u=!0):v+=_}return v+="'",u===!0&&(v=" E"+v),v}_pulseQueryQueue(){if(this.readyForQuery===!0)if(this.activeQuery=this.queryQueue.shift(),this.activeQuery){this.readyForQuery=!1,this.hasExecuted=!0;let d=this.activeQuery.submit(this.connection);d&&J.nextTick(()=>{this.activeQuery.handleError(d,this.connection),this.readyForQuery=!0,this._pulseQueryQueue()})}else this.hasExecuted&&(this.activeQuery=null,this.emit("drain"))}query(d,u,v){var w,_,E,M,O;if(d==null)throw new TypeError("Client was passed a null or undefined query");return typeof d.submit=="function"?(E=d.query_timeout||this.connectionParameters.query_timeout,_=w=d,typeof u=="function"&&(w.callback=w.callback||u)):(E=this.connectionParameters.query_timeout,w=new p(d,u,v),w.callback||(_=new this._Promise((k,C)=>{w.callback=(L,S)=>L?C(L):k(S)}))),E&&(O=w.callback,M=setTimeout(()=>{var k=new Error("Query read timeout");J.nextTick(()=>{w.handleError(k,this.connection)}),O(k),w.callback=()=>{};var C=this.queryQueue.indexOf(w);C>-1&&this.queryQueue.splice(C,1),this._pulseQueryQueue()},E),w.callback=(k,C)=>{clearTimeout(M),O(k,C)}),this.binary&&!w.binary&&(w.binary=!0),w._result&&!w._result._types&&(w._result._types=this._types),this._queryable?this._ending?(J.nextTick(()=>{w.handleError(new Error("Client was closed and is not queryable"),this.connection)}),_):(this.queryQueue.push(w),this._pulseQueryQueue(),_):(J.nextTick(()=>{w.handleError(new Error("Client has encountered a connection error and is not queryable"),this.connection)}),_)}ref(){this.connection.ref()}unref(){this.connection.unref()}end(d){if(this._ending=!0,!this.connection._connecting)if(d)d();else return this._Promise.resolve();if(this.activeQuery||!this._queryable?this.connection.stream.destroy():this.connection.end(),d)this.connection.once("end",d);else return new this._Promise(u=>{this.connection.once("end",u)})}};m(x,"Client");var b=x;b.Query=p,t.exports=b}),$a=Z((e,t)=>{q();var s=Xe().EventEmitter,i=m(function(){},"NOOP"),a=m((d,u)=>{let v=d.findIndex(u);return v===-1?void 0:d.splice(v,1)[0]},"removeWhere"),n=class{constructor(u,v,w){this.client=u,this.idleListener=v,this.timeoutId=w}};m(n,"IdleItem");var l=n,o=class{constructor(u){this.callback=u}};m(o,"PendingItem");var p=o;function f(){throw new Error("Release called on client which has already been released to the pool.")}m(f,"throwOnDoubleRelease");function g(d,u){if(u)return{callback:u,result:void 0};let v,w,_=m(function(M,O){M?v(M):w(O)},"cb"),E=new d(function(M,O){w=M,v=O}).catch(M=>{throw Error.captureStackTrace(M),M});return{callback:_,result:E}}m(g,"promisify");function x(d,u){return m(function v(w){w.client=u,u.removeListener("error",v),u.on("error",()=>{d.log("additional client error after disconnection due to error",w)}),d._remove(u),d.emit("error",w,u)},"idleListener")}m(x,"makeIdleListener");var b=class extends s{constructor(u,v){super(),this.options=Object.assign({},u),u!=null&&"password"in u&&Object.defineProperty(this.options,"password",{configurable:!0,enumerable:!1,writable:!0,value:u.password}),u!=null&&u.ssl&&u.ssl.key&&Object.defineProperty(this.options.ssl,"key",{enumerable:!1}),this.options.max=this.options.max||this.options.poolSize||10,this.options.min=this.options.min||0,this.options.maxUses=this.options.maxUses||1/0,this.options.allowExitOnIdle=this.options.allowExitOnIdle||!1,this.options.maxLifetimeSeconds=this.options.maxLifetimeSeconds||0,this.log=this.options.log||function(){},this.Client=this.options.Client||v||ts().Client,this.Promise=this.options.Promise||Xt.Promise,typeof this.options.idleTimeoutMillis>"u"&&(this.options.idleTimeoutMillis=1e4),this._clients=[],this._idle=[],this._expired=new WeakSet,this._pendingQueue=[],this._endCallback=void 0,this.ending=!1,this.ended=!1}_isFull(){return this._clients.length>=this.options.max}_isAboveMin(){return this._clients.length>this.options.min}_pulseQueue(){if(this.log("pulse queue"),this.ended){this.log("pulse queue ended");return}if(this.ending){this.log("pulse queue on ending"),this._idle.length&&this._idle.slice().map(v=>{this._remove(v.client)}),this._clients.length||(this.ended=!0,this._endCallback());return}if(!this._pendingQueue.length){this.log("no queued requests");return}if(!this._idle.length&&this._isFull())return;let u=this._pendingQueue.shift();if(this._idle.length){let v=this._idle.pop();clearTimeout(v.timeoutId);let w=v.client;w.ref&&w.ref();let _=v.idleListener;return this._acquireClient(w,u,_,!1)}if(!this._isFull())return this.newClient(u);throw new Error("unexpected condition")}_remove(u){let v=a(this._idle,w=>w.client===u);v!==void 0&&clearTimeout(v.timeoutId),this._clients=this._clients.filter(w=>w!==u),u.end(),this.emit("remove",u)}connect(u){if(this.ending){let _=new Error("Cannot use a pool after calling end on the pool");return u?u(_):this.Promise.reject(_)}let v=g(this.Promise,u),w=v.result;if(this._isFull()||this._idle.length){if(this._idle.length&&J.nextTick(()=>this._pulseQueue()),!this.options.connectionTimeoutMillis)return this._pendingQueue.push(new p(v.callback)),w;let _=m((O,k,C)=>{clearTimeout(M),v.callback(O,k,C)},"queueCallback"),E=new p(_),M=setTimeout(()=>{a(this._pendingQueue,O=>O.callback===_),E.timedOut=!0,v.callback(new Error("timeout exceeded when trying to connect"))},this.options.connectionTimeoutMillis);return M.unref&&M.unref(),this._pendingQueue.push(E),w}return this.newClient(new p(v.callback)),w}newClient(u){let v=new this.Client(this.options);this._clients.push(v);let w=x(this,v);this.log("checking client timeout");let _,E=!1;this.options.connectionTimeoutMillis&&(_=setTimeout(()=>{this.log("ending client due to timeout"),E=!0,v.connection?v.connection.stream.destroy():v.end()},this.options.connectionTimeoutMillis)),this.log("connecting new client"),v.connect(M=>{if(_&&clearTimeout(_),v.on("error",w),M)this.log("client failed to connect",M),this._clients=this._clients.filter(O=>O!==v),E&&(M=new Error("Connection terminated due to connection timeout",{cause:M})),this._pulseQueue(),u.timedOut||u.callback(M,void 0,i);else{if(this.log("new client connected"),this.options.maxLifetimeSeconds!==0){let O=setTimeout(()=>{this.log("ending client due to expired lifetime"),this._expired.add(v),this._idle.findIndex(k=>k.client===v)!==-1&&this._acquireClient(v,new p((k,C,L)=>L()),w,!1)},this.options.maxLifetimeSeconds*1e3);O.unref(),v.once("end",()=>clearTimeout(O))}return this._acquireClient(v,u,w,!0)}})}_acquireClient(u,v,w,_){_&&this.emit("connect",u),this.emit("acquire",u),u.release=this._releaseOnce(u,w),u.removeListener("error",w),v.timedOut?_&&this.options.verify?this.options.verify(u,u.release):u.release():_&&this.options.verify?this.options.verify(u,E=>{if(E)return u.release(E),v.callback(E,void 0,i);v.callback(void 0,u,u.release)}):v.callback(void 0,u,u.release)}_releaseOnce(u,v){let w=!1;return _=>{w&&f(),w=!0,this._release(u,v,_)}}_release(u,v,w){if(u.on("error",v),u._poolUseCount=(u._poolUseCount||0)+1,this.emit("release",w,u),w||this.ending||!u._queryable||u._ending||u._poolUseCount>=this.options.maxUses){u._poolUseCount>=this.options.maxUses&&this.log("remove expended client"),this._remove(u),this._pulseQueue();return}if(this._expired.has(u)){this.log("remove expired client"),this._expired.delete(u),this._remove(u),this._pulseQueue();return}let _;this.options.idleTimeoutMillis&&this._isAboveMin()&&(_=setTimeout(()=>{this.log("remove idle client"),this._remove(u)},this.options.idleTimeoutMillis),this.options.allowExitOnIdle&&_.unref()),this.options.allowExitOnIdle&&u.unref(),this._idle.push(new l(u,v,_)),this._pulseQueue()}query(u,v,w){if(typeof u=="function"){let E=g(this.Promise,u);return xs(function(){return E.callback(new Error("Passing a function as the first parameter to pool.query is not supported"))}),E.result}typeof v=="function"&&(w=v,v=void 0);let _=g(this.Promise,w);return w=_.callback,this.connect((E,M)=>{if(E)return w(E);let O=!1,k=m(C=>{O||(O=!0,M.release(C),w(C))},"onError");M.once("error",k),this.log("dispatching query");try{M.query(u,v,(C,L)=>{if(this.log("query dispatched"),M.removeListener("error",k),!O)return O=!0,M.release(C),C?w(C):w(void 0,L)})}catch(C){return M.release(C),w(C)}}),_.result}end(u){if(this.log("ending"),this.ending){let w=new Error("Called end on pool more than once");return u?u(w):this.Promise.reject(w)}this.ending=!0;let v=g(this.Promise,u);return this._endCallback=v.callback,this._pulseQueue(),v.result}get waitingCount(){return this._pendingQueue.length}get idleCount(){return this._idle.length}get expiredCount(){return this._clients.reduce((u,v)=>u+(this._expired.has(v)?1:0),0)}get totalCount(){return this._clients.length}};m(b,"Pool");var y=b;t.exports=y}),Ki={};Se(Ki,{default:()=>Ji});var Ji,qa=me(()=>{q(),Ji={}}),Ha=Z((e,t)=>{t.exports={name:"pg",version:"8.8.0",description:"PostgreSQL client - pure javascript & libpq with the same API",keywords:["database","libpq","pg","postgre","postgres","postgresql","rdbms"],homepage:"https://github.com/brianc/node-postgres",repository:{type:"git",url:"git://github.com/brianc/node-postgres.git",directory:"packages/pg"},author:"Brian Carlson <brian.m.carlson@gmail.com>",main:"./lib",dependencies:{"buffer-writer":"2.0.0","packet-reader":"1.0.0","pg-connection-string":"^2.5.0","pg-pool":"^3.5.2","pg-protocol":"^1.5.0","pg-types":"^2.1.0",pgpass:"1.x"},devDependencies:{async:"2.6.4",bluebird:"3.5.2",co:"4.6.0","pg-copy-streams":"0.3.0"},peerDependencies:{"pg-native":">=3.0.1"},peerDependenciesMeta:{"pg-native":{optional:!0}},scripts:{test:"make test-all"},files:["lib","SPONSORS.md"],license:"MIT",engines:{node:">= 8.0.0"},gitHead:"c99fb2c127ddf8d712500db2c7b9a5491a178655"}}),Va=Z((e,t)=>{q();var s=Xe().EventEmitter,i=(es(),ue(Ot)),a=Zt(),n=t.exports=function(o,p,f){s.call(this),o=a.normalizeQueryConfig(o,p,f),this.text=o.text,this.values=o.values,this.name=o.name,this.callback=o.callback,this.state="new",this._arrayMode=o.rowMode==="array",this._emitRowEvents=!1,this.on("newListener",(function(g){g==="row"&&(this._emitRowEvents=!0)}).bind(this))};i.inherits(n,s);var l={sqlState:"code",statementPosition:"position",messagePrimary:"message",context:"where",schemaName:"schema",tableName:"table",columnName:"column",dataTypeName:"dataType",constraintName:"constraint",sourceFile:"file",sourceLine:"line",sourceFunction:"routine"};n.prototype.handleError=function(o){var p=this.native.pq.resultErrorFields();if(p)for(var f in p){var g=l[f]||f;o[g]=p[f]}this.callback?this.callback(o):this.emit("error",o),this.state="error"},n.prototype.then=function(o,p){return this._getPromise().then(o,p)},n.prototype.catch=function(o){return this._getPromise().catch(o)},n.prototype._getPromise=function(){return this._promise?this._promise:(this._promise=new Promise((function(o,p){this._once("end",o),this._once("error",p)}).bind(this)),this._promise)},n.prototype.submit=function(o){this.state="running";var p=this;this.native=o.native,o.native.arrayMode=this._arrayMode;var f=m(function(b,y,d){if(o.native.arrayMode=!1,xs(function(){p.emit("_done")}),b)return p.handleError(b);p._emitRowEvents&&(d.length>1?y.forEach((u,v)=>{u.forEach(w=>{p.emit("row",w,d[v])})}):y.forEach(function(u){p.emit("row",u,d)})),p.state="end",p.emit("end",d),p.callback&&p.callback(null,d)},"after");if(J.domain&&(f=J.domain.bind(f)),this.name){this.name.length>63&&(console.error("Warning! Postgres only supports 63 characters for query names."),console.error("You supplied %s (%s)",this.name,this.name.length),console.error("This can cause conflicts and silent errors executing queries"));var g=(this.values||[]).map(a.prepareValue);if(o.namedQueries[this.name]){if(this.text&&o.namedQueries[this.name]!==this.text){let b=new Error(`Prepared statements must be unique - '${this.name}' was used for a different statement`);return f(b)}return o.native.execute(this.name,g,f)}return o.native.prepare(this.name,this.text,g.length,function(b){return b?f(b):(o.namedQueries[p.name]=p.text,p.native.execute(p.name,g,f))})}else if(this.values){if(!Array.isArray(this.values)){let b=new Error("Query values must be an array");return f(b)}var x=this.values.map(a.prepareValue);o.native.query(this.text,x,f)}else o.native.query(this.text,f)}}),Wa=Z((e,t)=>{q();var s=(qa(),ue(Ki)),i=_s();Ha();var a=Xe().EventEmitter,n=(es(),ue(Ot)),l=Is(),o=Va(),p=t.exports=function(f){a.call(this),f=f||{},this._Promise=f.Promise||Xt.Promise,this._types=new i(f.types),this.native=new s({types:this._types}),this._queryQueue=[],this._ending=!1,this._connecting=!1,this._connected=!1,this._queryable=!0;var g=this.connectionParameters=new l(f);this.user=g.user,Object.defineProperty(this,"password",{configurable:!0,enumerable:!1,writable:!0,value:g.password}),this.database=g.database,this.host=g.host,this.port=g.port,this.namedQueries={}};p.Query=o,n.inherits(p,a),p.prototype._errorAllQueries=function(f){let g=m(x=>{J.nextTick(()=>{x.native=this.native,x.handleError(f)})},"enqueueError");this._hasActiveQuery()&&(g(this._activeQuery),this._activeQuery=null),this._queryQueue.forEach(g),this._queryQueue.length=0},p.prototype._connect=function(f){var g=this;if(this._connecting){J.nextTick(()=>f(new Error("Client has already been connected. You cannot reuse a client.")));return}this._connecting=!0,this.connectionParameters.getLibpqConnectionString(function(x,b){if(x)return f(x);g.native.connect(b,function(y){if(y)return g.native.end(),f(y);g._connected=!0,g.native.on("error",function(d){g._queryable=!1,g._errorAllQueries(d),g.emit("error",d)}),g.native.on("notification",function(d){g.emit("notification",{channel:d.relname,payload:d.extra})}),g.emit("connect"),g._pulseQueryQueue(!0),f()})})},p.prototype.connect=function(f){if(f){this._connect(f);return}return new this._Promise((g,x)=>{this._connect(b=>{b?x(b):g()})})},p.prototype.query=function(f,g,x){var b,y,d,u,v;if(f==null)throw new TypeError("Client was passed a null or undefined query");if(typeof f.submit=="function")d=f.query_timeout||this.connectionParameters.query_timeout,y=b=f,typeof g=="function"&&(f.callback=g);else if(d=this.connectionParameters.query_timeout,b=new o(f,g,x),!b.callback){let w,_;y=new this._Promise((E,M)=>{w=E,_=M}),b.callback=(E,M)=>E?_(E):w(M)}return d&&(v=b.callback,u=setTimeout(()=>{var w=new Error("Query read timeout");J.nextTick(()=>{b.handleError(w,this.connection)}),v(w),b.callback=()=>{};var _=this._queryQueue.indexOf(b);_>-1&&this._queryQueue.splice(_,1),this._pulseQueryQueue()},d),b.callback=(w,_)=>{clearTimeout(u),v(w,_)}),this._queryable?this._ending?(b.native=this.native,J.nextTick(()=>{b.handleError(new Error("Client was closed and is not queryable"))}),y):(this._queryQueue.push(b),this._pulseQueryQueue(),y):(b.native=this.native,J.nextTick(()=>{b.handleError(new Error("Client has encountered a connection error and is not queryable"))}),y)},p.prototype.end=function(f){var g=this;this._ending=!0,this._connected||this.once("connect",this.end.bind(this,f));var x;return f||(x=new this._Promise(function(b,y){f=m(d=>d?y(d):b(),"cb")})),this.native.end(function(){g._errorAllQueries(new Error("Connection terminated")),J.nextTick(()=>{g.emit("end"),f&&f()})}),x},p.prototype._hasActiveQuery=function(){return this._activeQuery&&this._activeQuery.state!=="error"&&this._activeQuery.state!=="end"},p.prototype._pulseQueryQueue=function(f){if(this._connected&&!this._hasActiveQuery()){var g=this._queryQueue.shift();if(!g){f||this.emit("drain");return}this._activeQuery=g,g.submit(this);var x=this;g.once("_done",function(){x._pulseQueryQueue()})}},p.prototype.cancel=function(f){this._activeQuery===f?this.native.cancel(function(){}):this._queryQueue.indexOf(f)!==-1&&this._queryQueue.splice(this._queryQueue.indexOf(f),1)},p.prototype.ref=function(){},p.prototype.unref=function(){},p.prototype.setTypeParser=function(f,g,x){return this._types.setTypeParser(f,g,x)},p.prototype.getTypeParser=function(f,g){return this._types.getTypeParser(f,g)}}),Hs=Z((e,t)=>{q(),t.exports=Wa()}),ts=Z((e,t)=>{q();var s=ja(),i=Jt(),a=Xi(),n=$a(),{DatabaseError:l}=Gi(),o=m(f=>{var g;return g=class extends n{constructor(x){super(x,f)}},m(g,"BoundPool"),g},"poolFactory"),p=m(function(f){this.defaults=i,this.Client=f,this.Query=this.Client.Query,this.Pool=o(this.Client),this._pools=[],this.Connection=a,this.types=Kt(),this.DatabaseError=l},"PG");typeof J.env.NODE_PG_FORCE_NATIVE<"u"?t.exports=new p(Hs()):(t.exports=new p(s),Object.defineProperty(t.exports,"native",{configurable:!0,enumerable:!1,get(){var f=null;try{f=new p(Hs())}catch(g){if(g.code!=="MODULE_NOT_FOUND")throw g}return Object.defineProperty(t.exports,"native",{value:f}),f}}))});q();q();Mt();Ii();q();var Ga=Object.defineProperty,Qa=Object.defineProperties,Ya=Object.getOwnPropertyDescriptors,Vs=Object.getOwnPropertySymbols,Xa=Object.prototype.hasOwnProperty,Ka=Object.prototype.propertyIsEnumerable,Ws=m((e,t,s)=>t in e?Ga(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,"__defNormalProp"),Ja=m((e,t)=>{for(var s in t||(t={}))Xa.call(t,s)&&Ws(e,s,t[s]);if(Vs)for(var s of Vs(t))Ka.call(t,s)&&Ws(e,s,t[s]);return e},"__spreadValues"),Za=m((e,t)=>Qa(e,Ya(t)),"__spreadProps"),en=1008e3,Gs=new Uint8Array(new Uint16Array([258]).buffer)[0]===2,tn=new TextDecoder,Cs=new TextEncoder,Ut=Cs.encode("0123456789abcdef"),zt=Cs.encode("0123456789ABCDEF"),sn=Cs.encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"),Zi=sn.slice();Zi[62]=45;Zi[63]=95;var xt,jt;function er(e,{alphabet:t,scratchArr:s}={}){if(!xt)if(xt=new Uint16Array(256),jt=new Uint16Array(256),Gs)for(let y=0;y<256;y++)xt[y]=Ut[y&15]<<8|Ut[y>>>4],jt[y]=zt[y&15]<<8|zt[y>>>4];else for(let y=0;y<256;y++)xt[y]=Ut[y&15]|Ut[y>>>4]<<8,jt[y]=zt[y&15]|zt[y>>>4]<<8;e.byteOffset%4!==0&&(e=new Uint8Array(e));let i=e.length,a=i>>>1,n=i>>>2,l=s||new Uint16Array(i),o=new Uint32Array(e.buffer,e.byteOffset,n),p=new Uint32Array(l.buffer,l.byteOffset,a),f=t==="upper"?jt:xt,g=0,x=0,b;if(Gs)for(;g<n;)b=o[g++],p[x++]=f[b>>>8&255]<<16|f[b&255],p[x++]=f[b>>>24]<<16|f[b>>>16&255];else for(;g<n;)b=o[g++],p[x++]=f[b>>>24]<<16|f[b>>>16&255],p[x++]=f[b>>>8&255]<<16|f[b&255];for(g<<=2;g<i;)l[g]=f[e[g++]];return tn.decode(l.subarray(0,i))}m(er,"_toHex");function tr(e,t={}){let s="",i=e.length,a=en>>>1,n=Math.ceil(i/a),l=new Uint16Array(n>1?a:i);for(let o=0;o<n;o++){let p=o*a,f=p+a;s+=er(e.subarray(p,f),Za(Ja({},t),{scratchArr:l}))}return s}m(tr,"_toHexChunked");function sr(e,t={}){return t.alphabet!=="upper"&&typeof e.toHex=="function"?e.toHex():tr(e,t)}m(sr,"toHex");q();var ir=class rr{constructor(t,s){this.strings=t,this.values=s}toParameterizedQuery(t={query:"",params:[]}){var a;let{strings:s,values:i}=this;for(let n=0,l=s.length;n<l;n++)if(t.query+=s[n],n<i.length){let o=i[n];if(o instanceof or)t.query+=o.sql;else if(o instanceof Vt)if(o.queryData instanceof rr)o.queryData.toParameterizedQuery(t);else{if((a=o.queryData.params)!=null&&a.length)throw new Error("This query is not composable");t.query+=o.queryData.query}else{let{params:p}=t;p.push(o),t.query+="$"+p.length,(o instanceof W||ArrayBuffer.isView(o))&&(t.query+="::bytea")}}return t}};m(ir,"SqlTemplate");var ar=ir,nr=class{constructor(t){this.sql=t}};m(nr,"UnsafeRawSql");var or=nr;q();function Ls(){typeof window<"u"&&typeof document<"u"&&typeof console<"u"&&typeof console.warn=="function"&&console.warn(`          
        ...
        *  parameter.                                              *
        *                                                          *
        ************************************************************`)}m(Ls,"warnIfBrowser");Mt();var rn=Ye(_s()),an=Ye(Zt()),lr=class dr extends Error{constructor(t){super(t),Q(this,"name","NeonDbError"),Q(this,"severity"),Q(this,"code"),Q(this,"detail"),Q(this,"hint"),Q(this,"position"),Q(this,"internalPosition"),Q(this,"internalQuery"),Q(this,"where"),Q(this,"schema"),Q(this,"table"),Q(this,"column"),Q(this,"dataType"),Q(this,"constraint"),Q(this,"file"),Q(this,"line"),Q(this,"routine"),Q(this,"sourceError"),"captureStackTrace"in Error&&typeof Error.captureStackTrace=="function"&&Error.captureStackTrace(this,dr)}};m(lr,"NeonDbError");var rt=lr,Qs="transaction() expects an array of queries, or a function returning an array of queries",nn=["severity","code","detail","hint","position","internalPosition","internalQuery","where","schema","table","column","dataType","constraint","file","line","routine"];function cr(e){return e instanceof W?"\\x"+sr(e):e}m(cr,"encodeBuffersAsBytea");function ms(e){let{query:t,params:s}=e instanceof ar?e.toParameterizedQuery():e;return{query:t,params:s.map(i=>cr((0,an.prepareValue)(i)))}}m(ms,"prepareQuery");function As(e,{arrayMode:t,fullResults:s,fetchOptions:i,isolationLevel:a,readOnly:n,deferrable:l,authToken:o,disableWarningInBrowsers:p}={}){if(!e)throw new Error("No database connection string was provided to `neon()`. Perhaps an environment variable has not been set?");let f;try{f=ws(e)}catch{throw new Error("Database connection string provided to `neon()` is not a valid URL. Connection string: "+String(e))}let{protocol:g,username:x,hostname:b,port:y,pathname:d}=f;if(g!=="postgres:"&&g!=="postgresql:"||!x||!b||!d)throw new Error("Database connection string format for `neon()` should be: postgresql://user:password@host.tld/dbname?option=value");function u(w,..._){if(!(Array.isArray(w)&&Array.isArray(w.raw)&&Array.isArray(_)))throw new Error('This function can now be called only as a tagged-template function: sql`SELECT ${value}`, not sql("SELECT $1", [value], options). For a conventional function call with value placeholders ($1, $2, etc.), use sql.query("SELECT $1", [value], options).');return new Vt(v,new ar(w,_))}m(u,"templateFn"),u.query=(w,_,E)=>new Vt(v,{query:w,params:_??[]},E),u.unsafe=w=>new or(w),u.transaction=async(w,_)=>{if(typeof w=="function"&&(w=w(u)),!Array.isArray(w))throw new Error(Qs);w.forEach(O=>{if(!(O instanceof Vt))throw new Error(Qs)});let E=w.map(O=>O.queryData),M=w.map(O=>O.opts??{});return v(E,M,_)};async function v(w,_,E){let{fetchEndpoint:M,fetchFunction:O}=kt,k=Array.isArray(w)?{queries:w.map(te=>ms(te))}:ms(w),C=i??{},L=t??!1,S=s??!1,R=a,A=n,z=l;E!==void 0&&(E.fetchOptions!==void 0&&(C={...C,...E.fetchOptions}),E.arrayMode!==void 0&&(L=E.arrayMode),E.fullResults!==void 0&&(S=E.fullResults),E.isolationLevel!==void 0&&(R=E.isolationLevel),E.readOnly!==void 0&&(A=E.readOnly),E.deferrable!==void 0&&(z=E.deferrable)),_!==void 0&&!Array.isArray(_)&&_.fetchOptions!==void 0&&(C={...C,..._.fetchOptions});let $=o;!Array.isArray(_)&&(_==null?void 0:_.authToken)!==void 0&&($=_.authToken);let D=typeof M=="function"?M(b,y,{jwtAuth:$!==void 0}):M,U={"Neon-Connection-String":e,"Neon-Raw-Text-Output":"true","Neon-Array-Mode":"true"},V=await ur($);V&&(U.Authorization=`Bearer ${V}`),Array.isArray(w)&&(R!==void 0&&(U["Neon-Batch-Isolation-Level"]=R),A!==void 0&&(U["Neon-Batch-Read-Only"]=String(A)),z!==void 0&&(U["Neon-Batch-Deferrable"]=String(z))),p||kt.disableWarningInBrowsers||Ls();let Y;try{Y=await(O??fetch)(D,{method:"POST",body:JSON.stringify(k),headers:U,...C})}catch(te){let K=new rt(`Error connecting to database: ${te}`);throw K.sourceError=te,K}if(Y.ok){let te=await Y.json();if(Array.isArray(w)){let K=te.results;if(!Array.isArray(K))throw new rt("Neon internal error: unexpected result format");return K.map((be,ie)=>{let le=_[ie]??{},ht=le.arrayMode??L,gt=le.fullResults??S;return bs(be,{arrayMode:ht,fullResults:gt,types:le.types})})}else{let K=_??{},be=K.arrayMode??L,ie=K.fullResults??S;return bs(te,{arrayMode:be,fullResults:ie,types:K.types})}}else{let{status:te}=Y;if(te===400){let K=await Y.json(),be=new rt(K.message);for(let ie of nn)be[ie]=K[ie]??void 0;throw be}else{let K=await Y.text();throw new rt(`Server error (HTTP status ${te}): ${K}`)}}}return m(v,"execute"),u}m(As,"neon");var pr=class{constructor(t,s,i){this.execute=t,this.queryData=s,this.opts=i}then(t,s){return this.execute(this.queryData,this.opts).then(t,s)}catch(t){return this.execute(this.queryData,this.opts).catch(t)}finally(t){return this.execute(this.queryData,this.opts).finally(t)}};m(pr,"NeonQueryPromise");var Vt=pr;function bs(e,{arrayMode:t,fullResults:s,types:i}){let a=new rn.default(i),n=e.fields.map(p=>p.name),l=e.fields.map(p=>a.getTypeParser(p.dataTypeID)),o=t===!0?e.rows.map(p=>p.map((f,g)=>f===null?null:l[g](f))):e.rows.map(p=>Object.fromEntries(p.map((f,g)=>[n[g],f===null?null:l[g](f)])));return s?(e.viaNeonFetch=!0,e.rowAsArray=t,e.rows=o,e._parsers=l,e._types=a,e):o}m(bs,"processQueryResult");async function ur(e){if(typeof e=="string")return e;if(typeof e=="function")try{return await Promise.resolve(e())}catch(t){let s=new rt("Error getting auth token.");throw t instanceof Error&&(s=new rt(`Error getting auth token: ${t.message}`)),s}}m(ur,"getAuthToken");q();var on=Ye(ts());q();var ln=Ye(ts()),fr=class extends ln.Client{constructor(t){super(t),this.config=t}get neonConfig(){return this.connection.stream}connect(t){var f,g;let{neonConfig:s}=this;s.forceDisablePgSSL&&(this.ssl=this.connection.ssl=!1),this.ssl&&s.useSecureWebSocket&&console.warn("SSL is enabled for both Postgres (e.g. ?sslmode=require in the connection string + forceDisablePgSSL = false) and the WebSocket tunnel (useSecureWebSocket = true). Double encryption will increase latency and CPU usage. It may be appropriate to disable SSL in the Postgres connection parameters or set forceDisablePgSSL = true.");let i=typeof this.config!="string"&&((f=this.config)==null?void 0:f.host)!==void 0||typeof this.config!="string"&&((g=this.config)==null?void 0:g.connectionString)!==void 0||J.env.PGHOST!==void 0,a=J.env.USER??J.env.USERNAME;if(!i&&this.host==="localhost"&&this.user===a&&this.database===a&&this.password===null)throw new Error(`No database host or connection string was set, and key parameters have default values (host: localhost, user: ${a}, db: ${a}, password: null). Is an environment variable missing? Alternatively, if you intended to connect with these parameters, please set the host to 'localhost' explicitly.`);let n=super.connect(t),l=s.pipelineTLS&&this.ssl,o=s.pipelineConnect==="password";if(!l&&!s.pipelineConnect)return n;let p=this.connection;if(l&&p.on("connect",()=>p.stream.emit("data","S")),o){p.removeAllListeners("authenticationCleartextPassword"),p.removeAllListeners("readyForQuery"),p.once("readyForQuery",()=>p.on("readyForQuery",this._handleReadyForQuery.bind(this)));let x=this.ssl?"sslconnect":"connect";p.on(x,()=>{this.neonConfig.disableWarningInBrowsers||Ls(),this._handleAuthCleartextPassword(),this._handleReadyForQuery()})}return n}async _handleAuthSASLContinue(t){if(typeof crypto>"u"||crypto.subtle===void 0||crypto.subtle.importKey===void 0)throw new Error("Cannot use SASL auth when `crypto.subtle` is not defined");let s=crypto.subtle,i=this.saslSession,a=this.password,n=t.data;if(i.message!=="SASLInitialResponse"||typeof a!="string"||typeof n!="string")throw new Error("SASL: protocol error");let l=Object.fromEntries(n.split(",").map(te=>{if(!/^.=/.test(te))throw new Error("SASL: Invalid attribute pair entry");let K=te[0],be=te.substring(2);return[K,be]})),o=l.r,p=l.s,f=l.i;if(!o||!/^[!-+--~]+$/.test(o))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce missing/unprintable");if(!p||!/^(?:[a-zA-Z0-9+/]{4})*(?:[a-zA-Z0-9+/]{2}==|[a-zA-Z0-9+/]{3}=)?$/.test(p))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: salt missing/not base64");if(!f||!/^[1-9][0-9]*$/.test(f))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: missing/invalid iteration count");if(!o.startsWith(i.clientNonce))throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce does not start with client nonce");if(o.length===i.clientNonce.length)throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too short");let g=parseInt(f,10),x=W.from(p,"base64"),b=new TextEncoder,y=b.encode(a),d=await s.importKey("raw",y,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),u=new Uint8Array(await s.sign("HMAC",d,W.concat([x,W.from([0,0,0,1])]))),v=u;for(var w=0;w<g-1;w++)u=new Uint8Array(await s.sign("HMAC",d,u)),v=W.from(v.map((te,K)=>v[K]^u[K]));let _=v,E=await s.importKey("raw",_,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),M=new Uint8Array(await s.sign("HMAC",E,b.encode("Client Key"))),O=await s.digest("SHA-256",M),k="n=*,r="+i.clientNonce,C="r="+o+",s="+p+",i="+g,L="c=biws,r="+o,S=k+","+C+","+L,R=await s.importKey("raw",O,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var A=new Uint8Array(await s.sign("HMAC",R,b.encode(S))),z=W.from(M.map((te,K)=>M[K]^A[K])),$=z.toString("base64");let D=await s.importKey("raw",_,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]),U=await s.sign("HMAC",D,b.encode("Server Key")),V=await s.importKey("raw",U,{name:"HMAC",hash:{name:"SHA-256"}},!1,["sign"]);var Y=W.from(await s.sign("HMAC",V,b.encode(S)));i.message="SASLResponse",i.serverSignature=Y.toString("base64"),i.response=L+",p="+$,this.connection.sendSCRAMClientFinalMessage(this.saslSession.response)}};m(fr,"NeonClient");var dn=fr;Mt();var cn=Ye(Is());function hr(e,t){if(t)return{callback:t,result:void 0};let s,i,a=m(function(l,o){l?s(l):i(o)},"cb"),n=new e(function(l,o){i=l,s=o});return{callback:a,result:n}}m(hr,"promisify");var pn=class extends on.Pool{constructor(){super(...arguments),Q(this,"Client",dn),Q(this,"hasFetchUnsupportedListeners",!1),Q(this,"addListener",this.on)}on(t,s){return t!=="error"&&(this.hasFetchUnsupportedListeners=!0),super.on(t,s)}query(t,s,i){var n;if(!kt.poolQueryViaFetch||this.hasFetchUnsupportedListeners||typeof t=="function")return super.query(t,s,i);typeof s=="function"&&(i=s,s=void 0);let a=hr(this.Promise,i);i=a.callback;try{let l=new cn.default(this.options),o=encodeURIComponent,p=encodeURI,f=`postgresql://${o(l.user)}:${o(l.password)}@${o(l.host)}/${p(l.database)}`,g=typeof t=="string"?t:t.text,x=s??t.values??[];As(f,{fullResults:!0,arrayMode:t.rowMode==="array"}).query(g,x,{types:t.types??((n=this.options)==null?void 0:n.types)}).then(b=>i(void 0,b)).catch(b=>i(b))}catch(l){i(l)}return a.result}};m(pn,"NeonPool");Mt();var Rt=Ye(ts());Rt.DatabaseError;Rt.defaults;Rt.escapeIdentifier;Rt.escapeLiteral;Rt.types;/*! Bundled license information:
...
buffer/index.js:
   ...
   * @license  MIT
   *)
*/var un={};const j=new _i,fn=un.DATABASE_URL||"postgresql://neondb_owner:npg_1PBkOmAWRcf2@ep-round-recipe-aqdgkjfj-pooler.c-8.us-east-1.aws.neon.tech/neondb?sslmode=require",B=As(fn);function ss(e){if(!e)return"";const t=e.split(/\s+/);for(let s=1;s<t.length;s++)if(t[s].endsWith("구")&&!t[s].endsWith("시구"))return t[s].replace(/구$/,"");for(let s=1;s<t.length;s++)if(t[s].endsWith("시")&&t[s]!==t[0])return t[s].replace(/(특별시|광역시|특별자치시|시)$/,"");return t[0]?t[0].replace(/(특별자치도|도)$/,""):""}function Ms(e){if(!e)return"";const t=e.split(/\s+/);return t[0]?t[0].replace(/(특별시|광역시|특별자치시|특별자치도|도|시)$/,""):""}function hn(e){return{마사지:"MassageTherapist",헤드스파:"BeautySalon",피부관리:"BeautySalon",헤어:"HairSalon",메이크업:"BeautySalon",왁싱:"BeautySalon",반영구:"BeautySalon",병원:"MedicalBusiness",그외:"LocalBusiness"}[e]||"LocalBusiness"}function gn(e){const t=ss(e.address),s=Ms(e.address),i=t||s;return`${e.name} ${i?i+" ":""}${e.category} 추천 | 마이뷰티맵`}function gr(e){const t=ss(e.address),s=Ms(e.address),i=Array.isArray(e.tags)&&e.tags.length?e.tags.join("·")+" ":"",a=t||s,n=e.price?` 가격 ${e.price}.`:"",l=e.desc?" "+e.desc.slice(0,40):"";return`${e.name} | ${a?a+" ":""}${e.category} 잘하는 곳. ${i}예약·위치·가격 한눈에 확인!${n}${l}`.slice(0,160)}function mn(e,t){return`${t} ${e} 추천 TOP | 마이뷰티맵`}function bn(e,t,s){return`${t} ${e} 잘하는 곳 ${s}곳 추천! 가격·위치·예약·후기까지 마이뷰티맵에서 한눈에 확인하세요.`}function vn(e,t){const s=t;return[`${s} ${e}`,`${s} ${e} 추천`,`${s} ${e} 잘하는 곳`,`${s} ${e} 예약`,`${s} ${e} 가격`,`${s} ${e} 후기`,`${s} ${e} 맛집`,`${s} 뷰티샵`,`${s} 뷰티 추천`,`${e} 추천`].join(",")}function ve(){return new Date(Date.now()+540*60*1e3).toISOString().slice(0,10)}function mr(){return new Date(Date.now()+540*60*1e3-864e5).toISOString().slice(0,10)}function br(e){const t=(e??"").trim();if(!t)return"";if(/^[A-Za-z0-9_-]{11}$/.test(t))return t;const s=t.match(/(?:youtu\.be\/|youtube\.com\/(?:watch\?(?:.*&)?v=|embed\/|shorts\/|v\/))([A-Za-z0-9_-]{11})/);return s?s[1]:t}function yn(e){return e.plan!=="shoot"||!e.paid_until?!1:new Date(e.paid_until)>=new Date}function Ue(e){return{id:e.id,name:e.name,category:e.category,tags:e.tags??[],price:e.price??"",address:e.address??"",district:e.district??"",lat:parseFloat(e.lat)||37.5326,lng:parseFloat(e.lng)||127.0246,smartPlaceUrl:e.smart_place_url??"",youtubeId:e.youtube_id??"",featured:e.featured??!1,thumbnail:e.thumbnail??"",phone:e.phone??"",desc:e.description??"",active:e.active??!0,displayMode:e.display_mode??"both",plan:e.plan??"basic",paidUntil:e.paid_until??null,paymentStatus:e.payment_status??"unpaid",paymentMemo:e.payment_memo??"",views:parseInt(e.view_cnt)||0,feedSP:parseInt(e.feed_sp)||0,mapSP:parseInt(e.map_sp)||0,isPremium:yn(e),isRecommended:e.is_recommended??!1}}function xn(e,t,s,i){const n=(s-e)*Math.PI/180,l=(i-t)*Math.PI/180,o=Math.sin(n/2)**2+Math.cos(e*Math.PI/180)*Math.cos(s*Math.PI/180)*Math.sin(l/2)**2;return 6371*2*Math.atan2(Math.sqrt(o),Math.sqrt(1-o))}const vs=10;let Wt=!1,it=null;async function vr(){if(!Wt)return it||(it=(async()=>{try{if(await B`
        CREATE TABLE IF NOT EXISTS schema_migrations (
          version     INTEGER PRIMARY KEY,
          applied_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()
        )
      `,(await B`SELECT version FROM schema_migrations WHERE version = ${vs}`).length>0){Wt=!0;return}await B`
      ...
      `,await B`CREATE INDEX IF NOT EXISTS idx_se_session  ON session_events(session_id)`,await B`CREATE INDEX IF NOT EXISTS idx_se_occurred ON session_events(occurred_at)`,await B`ALTER TABLE shops             ADD COLUMN IF NOT EXISTS report_token   TEXT`,await B`ALTER TABLE shops             ADD COLUMN IF NOT EXISTS is_recommended BOOLEAN NOT NULL DEFAULT false`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS feed_view      INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS catalog_view   INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS map_view       INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS vts_feed       INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS vts_catalog    INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS vts_map        INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE daily_stats       ADD COLUMN IF NOT EXISTS rec_view       INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE honey_items       ADD COLUMN IF NOT EXISTS coupang_url2   TEXT    NOT NULL DEFAULT ''`,await B`ALTER TABLE shorts_items      ADD COLUMN IF NOT EXISTS smart_place_url TEXT   NOT NULL DEFAULT ''`,await B`ALTER TABLE shorts_items      ADD COLUMN IF NOT EXISTS view_cnt        INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE shorts_items      ADD COLUMN IF NOT EXISTS sp_cnt          INTEGER NOT NULL DEFAULT 0`,await B`ALTER TABLE session_events    ADD COLUMN IF NOT EXISTS viewed_sec      INTEGER NOT NULL DEFAULT 0`,await B`INSERT INTO schema_migrations (version) VALUES (${vs}) ON CONFLICT DO NOTHING`,Wt=!0}catch(e){console.error("[migration] error:",e),it=null}})(),it)}j.use("*",async(e,t)=>(await vr(),t()));j.get("/api/shops",async e=>{const t=e.req.query("category")??"",s=(e.req.query("q")??"").toLowerCase(),i=parseFloat(e.req.query("lat")??""),a=parseFloat(e.req.query("lng")??""),n=e.req.query("nearby")==="1",l=e.req.query("shuffle")==="1";let p=(await B`
  ...
  `).map(Ue);if(t==="recommended"?p=p.filter(f=>f.isRecommended):t&&t!=="all"&&(p=p.filter(f=>f.category===t)),s&&(p=p.filter(f=>f.name.toLowerCase().includes(s)||(f.tags||[]).some(g=>g.toLowerCase().includes(s))||f.district.toLowerCase().includes(s))),n&&!isNaN(i)&&!isNaN(a))p=p.map(f=>({...f,dist:xn(i,a,f.lat,f.lng)})).filter(f=>f.dist<=20).sort((f,g)=>f.isPremium&&!g.isPremium?-1:!f.isPremium&&g.isPremium?1:f.dist-g.dist);else if(l){const f=p.filter(x=>x.isPremium),g=p.filter(x=>!x.isPremium);for(let x=f.length-1;x>0;x--){const b=Math.floor(Math.random()*(x+1));[f[x],f[b]]=[f[b],f[x]]}for(let x=g.length-1;x>0;x--){const b=Math.floor(Math.random()*(x+1));[g[x],g[b]]=[g[b],g[x]]}p=[...f,...g]}else p.sort((f,g)=>f.isPremium&&!g.isPremium?-1:!f.isPremium&&g.isPremium?1:0);return e.json(p)});j.get("/api/geocode",async e=>{var o,p,f,g,x;const t=e.req.query("query")??"";if(!t)return e.json({error:"query required"},400);const s=b=>b.replace(/(로|길|번길)\s+(\d)/g,"$1$2"),i=[],a=s(t);a!==t&&i.push(a),i.push(t);const n=a.trim().split(/\s+/);n.length>3&&i.push(n.slice(0,-1).join(" "));const l=async b=>(await fetch(`https://maps.apigw.ntruss.com/map-geocode/v2/geocode?query=${encodeURIComponent(b)}`,{headers:{"X-NCP-APIGW-API-KEY-ID":"xjjg4490h8","X-NCP-APIGW-API-KEY":"RB4DFA4ZEF2iHtkerlNrqzoG8P8YHwE2UddGrAtD"}})).json();try{let b=null;for(const _ of i){const E=await l(_);if((o=E.addresses)!=null&&o.length){b=E.addresses[0];break}}if(!b)return e.json({error:"주소를 찾을 수 없어요"},404);const y=b.addressElements||[],d=((p=y.find(_=>{var E;return(E=_.types)==null?void 0:E.includes("SIDO")}))==null?void 0:p.longName)||"",u=((f=y.find(_=>{var E;return(E=_.types)==null?void 0:E.includes("SIGUGUN")}))==null?void 0:f.longName)||"",v=((g=y.find(_=>{var E,M;return((E=_.types)==null?void 0:E.includes("DONGMYUN"))||((M=_.types)==null?void 0:M.includes("RI"))}))==null?void 0:g.longName)||"",w=[d,u,v].filter(Boolean).join(" ")||((x=b.roadAddress)==null?void 0:x.split(" ").slice(0,3).join(" "))||"";return e.json({lat:parseFloat(b.y),lng:parseFloat(b.x),address:b.roadAddress||b.jibunAddress,district:w})}catch{return e.json({error:"지오코딩 실패"},500)}});j.get("/api/shops/all",async e=>{const t=await B`
    SELECT s.*, COALESCE(st.view_cnt,0) as view_cnt,
           COALESCE(st.feed_sp,0) as feed_sp, COALESCE(st.map_sp,0) as map_sp
    FROM shops s LEFT JOIN stats st ON s.id = st.shop_id
    WHERE s.active = true ORDER BY s.id ASC
  `;return e.json(t.map(Ue))});j.get("/api/shops/:id",async e=>{const t=+e.req.param("id"),s=await B`
    SELECT s.*, COALESCE(st.view_cnt,0) as view_cnt,
           COALESCE(st.feed_sp,0) as feed_sp, COALESCE(st.map_sp,0) as map_sp
    FROM shops s LEFT JOIN stats st ON s.id = st.shop_id
    WHERE s.id = ${t}
  `;return s.length?e.json(Ue(s[0])):e.json({error:"not found"},404)});j.post("/api/admin/shops",async e=>{const t=await e.req.json(),s=Array.isArray(t.tags)?t.tags:(t.tags??"").split(",").map(n=>n.trim()).filter(Boolean),a=(await B`
    INSERT INTO shops
    ...
    VALUES
      (${t.name??"새 업체"}, ${t.category??"피부관리"}, ${s},
       ...
       ${t.smartPlaceUrl??""}, ${br(t.youtubeId??"")},
       ${t.featured??!1},
       ${t.thumbnail??""},
       ${t.phone??""}, ${t.desc??""}, true, ${t.displayMode??"both"})
    RETURNING *
  `)[0];return await B`INSERT INTO stats (shop_id) VALUES (${a.id}) ON CONFLICT DO NOTHING`,e.json(Ue(a))});j.put("/api/admin/shops/:id",async e=>{const t=+e.req.param("id"),s=await e.req.json(),i=Array.isArray(s.tags)?s.tags:(s.tags??"").split(",").map(n=>n.trim()).filter(Boolean),a=await B`
    UPDATE shops SET
      name            = ${s.name},
      category        = ${s.category},
      tags            = ${i},
    ...
    WHERE id = ${t}
    RETURNING *
  `;return a.length?(await B`INSERT INTO stats (shop_id) VALUES (${t}) ON CONFLICT DO NOTHING`,e.json(Ue(a[0]))):e.json({error:"not found"},404)});j.put("/api/admin/shops/:id/recommended",async e=>{const t=+e.req.param("id"),{isRecommended:s}=await e.req.json(),i=await B`
  ...
  `;return i.length?e.json({ok:!0,isRecommended:i[0].is_recommended}):e.json({error:"not found"},404)});j.post("/api/track/rec/:id",async e=>{const t=+e.req.param("id"),s=ve();try{await B`INSERT INTO daily_stats (shop_id, stat_date, rec_view)
    ...
    WHERE id = ${t}
    RETURNING *
  `;return i.length?e.json(Ue(i[0])):e.json({error:"not found"},404)});j.delete("/api/admin/shops/:id",async e=>{const t=+e.req.param("id");return await B`DELETE FROM shops WHERE id = ${t}`,e.json({ok:!0})});j.post("/api/track/view/:id",async e=>{const t=+e.req.param("id"),s=ve();let i="feed";try{const a=await e.req.json();["feed","catalog","map"].includes(a==null?void 0:a.source)&&(i=a.source)}catch{}return await B`INSERT INTO stats (shop_id, view_cnt) VALUES (${t}, 1)
      ON CONFLICT (shop_id) DO UPDATE SET view_cnt = stats.view_cnt + 1`,i==="feed"?await B`INSERT INTO daily_stats (shop_id, stat_date, view_cnt, feed_view)
              ...
              ON CONFLICT (shop_id, stat_date) DO UPDATE
                SET view_cnt  = daily_stats.view_cnt  + 1,
                    map_view  = daily_stats.map_view  + 1`,e.json({ok:!0})});j.post("/api/track/sp/:id",async e=>{const t=+e.req.param("id"),s=ve();let i=null;try{const a=await e.req.json();i=(a==null?void 0:a.viewSrc)||null}catch{}return await B`INSERT INTO stats (shop_id, feed_sp) VALUES (${t}, 1)
      ON CONFLICT (shop_id) DO UPDATE SET feed_sp = stats.feed_sp + 1`,i==="feed"?await B`INSERT INTO daily_stats (shop_id, stat_date, feed_sp, vts_feed)
              ...
              ON CONFLICT (shop_id, stat_date) DO UPDATE
                ...
                VALUES (${t}, ${s}, 1)
              ON CONFLICT (shop_id, stat_date) DO UPDATE
                SET feed_sp = daily_stats.feed_sp + 1`,e.json({ok:!0})});j.post("/api/track/mapsp/:id",async e=>{const t=+e.req.param("id"),s=ve();let i=null;try{const a=await e.req.json();i=(a==null?void 0:a.viewSrc)||null}catch{}return await B`INSERT INTO stats (shop_id, map_sp) VALUES (${t}, 1)
  ...
  `,e.json({ok:!0})});j.get("/api/admin/daily-visits",async e=>{const t=await B`
    ...
    LIMIT 30
  `;return e.json(t)});j.post("/api/admin/reset-stats",async e=>(await B`UPDATE stats SET view_cnt=0, feed_sp=0, map_sp=0`,await B`DELETE FROM daily_visits`,await B`DELETE FROM daily_stats`,e.json({ok:!0})));j.post("/api/admin/init-daily-stats",async e=>(Wt=!1,it=null,await B`DELETE FROM schema_migrations WHERE version = ${vs}`,await vr(),e.json({ok:!0})));j.get("/api/admin/stats",async e=>{const t=ve(),s=mr(),i=await B`
  ...
  `,e.json({ok:!0}))});j.get("/api/admin/calendar",async e=>{const t=parseInt(e.req.query("year")||String(new Date().getFullYear())),s=parseInt(e.req.query("month")||String(new Date().getMonth()+1)),i=`${t}-${String(s).padStart(2,"0")}-01`,a=new Date(t,s,0).toISOString().slice(0,10),n=await B`
    SELECT stat_date::text as stat_date,
           COALESCE(SUM(view_cnt),0) as views,
           COALESCE(SUM(feed_sp),0)  as feed_sp,
           COALESCE(SUM(map_sp),0)   as map_sp,
  ...
  `,x={};g.forEach(y=>{x[y.visit_date]=parseInt(y.visit_cnt)||0});const b=g.reduce((y,d)=>y+(parseInt(d.visit_cnt)||0),0);return e.json({year:t,month:s,monthTotal:{views:parseInt(f.views)||0,feedSP:parseInt(f.feed_sp)||0,mapSP:parseInt(f.map_sp)||0,visits:b},daily:n.map(y=>({date:y.stat_date,visits:x[y.stat_date]||0,views:parseInt(y.views)||0,feedSP:parseInt(y.feed_sp)||0,mapSP:parseInt(y.map_sp)||0,activeShops:parseInt(y.active_shops)||0})),shopDetail:o.map(y=>({id:y.id,name:y.name,category:y.category,thumbnail:y.thumbnail,views:parseInt(y.views)||0,feedSP:parseInt(y.feed_sp)||0,mapSP:parseInt(y.map_sp)||0}))})});j.get("/api/admin/inquiries",async e=>{const t=await B`SELECT * FROM inquiries ORDER BY created_at DESC`;return e.json(t)});j.get("/favicon.ico",e=>yr());j.get("/favicon.svg",e=>yr());function yr(e){return new Response('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#FF4D7D"/><text x="16" y="23" font-size="18" text-anchor="middle">💄</text></svg>',{headers:{"Content-Type":"image/svg+xml","Cache-Control":"public,max-age=86400"}})}j.get("/og-image.jpg",e=>{try{const t=Tr.join(process.cwd(),"public","og-image.jpg"),s=Sr.readFileSync(t);return new Response(s,{headers:{"Content-Type":"image/jpeg","Cache-Control":"public,max-age=86400"}})}catch{return e.notFound()}});j.post("/api/admin/upload-thumbnail",async e=>{const t=await e.req.json(),{shopId:s,dataUrl:i}=t;return!i||!s?e.json({error:"required"},400):(await B`UPDATE shops SET thumbnail = ${i} WHERE id = ${s}`,e.json({ok:!0,url:i}))});j.post("/api/admin/upload-shorts-video",async e=>{var t;try{const{dataUrl:s,folder:i}=await e.req.json();if(!s)return e.json({error:"dataUrl required"},400);const a=e.env.CLOUDINARY_CLOUD_NAME,n=e.env.CLOUDINARY_API_KEY,l=e.env.CLOUDINARY_API_SECRET;if(!a||!n||!l)return e.json({error:"Cloudinary env not set"},500);const o=i||"mybeautymap/shorts",p=Math.floor(Date.now()/1e3).toString(),f=`folder=${o}&resource_type=video&timestamp=${p}${l}`,g=new TextEncoder().encode(f),x=await crypto.subtle.digest("SHA-1",g),y=Array.from(new Uint8Array(x)).map(w=>w.toString(16).padStart(2,"0")).join(""),d=new FormData;d.append("file",s),d.append("api_key",n),d.append("timestamp",p),d.append("signature",y),d.append("folder",o),d.append("resource_type","video");const u=await fetch(`https://api.cloudinary.com/v1_1/${a}/video/upload`,{method:"POST",body:d}),v=await u.json();return u.ok?e.json({ok:!0,public_id:v.public_id,url:v.secure_url}):e.json({error:((t=v.error)==null?void 0:t.message)||"upload failed"},500)}catch(s){return e.json({error:s.message},500)}});j.post("/api/admin/fetch-naver-info",async e=>{try{const{url:t}=await e.req.json();if(!t)return e.json({error:"url required"},400);const i=await(await fetch(t,{redirect:"follow",headers:{"User-Agent":"Mozilla/5.0 (compatible; bot)"}})).text();let a="";const n=i.match(/<meta[^>]+property=["']og:title["'][^>]+content=["']([^"']+)["']/i),l=i.match(/<title[^>]*>([^<]+)<\/title>/i);a=((n==null?void 0:n[1])||(l==null?void 0:l[1])||"").replace(/\s*[\|｜]\s*네이버.*$/i,"").replace(/\s*-\s*네이버.*$/i,"").trim();let p="";const f=i.match(/<meta[^>]+property=["']og:description["'][^>]+content=["']([^"']+)["']/i),g=(f==null?void 0:f[1])||"",x=g.match(/(서울|경기|인천|부산|대구|광주|대전|울산|세종|강원|충북|충남|전북|전남|경북|경남|제주)[^\|,·]+/);x&&(p=x[0].trim());let b="";const y=["마사지","헤드스파","피부관리","헤어","메이크업","왁싱","반영구","병원"];for(const d of y)if(i.includes(d)||g.includes(d)){b=d;break}return a?e.json({name:a,address:p,category:b}):e.json({error:"업체 정보를 찾을 수 없습니다"},404)}catch(t){return e.json({error:t.message},500)}});j.get("/api/shorts",async e=>{try{const t=await B`
  ...
  `;return e.json(s[0])});j.put("/api/admin/shorts/:id",async e=>{const t=+e.req.param("id"),s=await e.req.json(),i=await B`
    UPDATE shorts_items SET
      ...
      active               = ${s.active!==!1}
    WHERE id = ${t} RETURNING *
  `;return e.json(i[0])});j.delete("/api/admin/shorts/:id",async e=>{const t=+e.req.param("id");return await B`DELETE FROM shorts_items WHERE id = ${t}`,e.json({ok:!0})});let Ys=!1;async function ft(){Ys||(await B`
    CREATE TABLE IF NOT EXISTS shorts_daily_stats (
      shorts_id  INTEGER NOT NULL,
      stat_date  DATE    NOT NULL,
      view_cnt   INTEGER NOT NULL DEFAULT 0,
  ...
  `,Ys=!0)}j.post("/api/track/shorts/view/:id",async e=>{const t=+e.req.param("id"),s=ve();await B`UPDATE shorts_items SET view_cnt = view_cnt + 1 WHERE id = ${t}`;try{await ft(),await B`
    ...
    `}catch{}return e.json({ok:!0})});j.post("/api/track/shorts/sp/:id",async e=>{const t=+e.req.param("id"),s=ve();await B`UPDATE shorts_items SET sp_cnt = sp_cnt + 1 WHERE id = ${t}`;try{await ft(),await B`
      INSERT INTO shorts_daily_stats (shorts_id, stat_date, sp_cnt)
      VALUES (${t}, ${s}, 1)
      ON CONFLICT (shorts_id, stat_date)
      DO UPDATE SET sp_cnt = shorts_daily_stats.sp_cnt + 1
    `}catch{}return e.json({ok:!0})});j.get("/api/admin/shorts/stats/summary",async e=>{const t=ve(),s=mr(),i=new Date(Date.now()-6*864e5).toISOString().slice(0,10);try{await ft();const[a]=await B`
    ...
    `,p=await B`SELECT COUNT(*) as cnt FROM shorts_items`,f=await B`SELECT COUNT(*) as cnt FROM shorts_items WHERE active = true`;return e.json({total_views:Number(a.total_views),total_sp:Number(a.total_sp),today_views:Number(n.views),today_sp:Number(n.sp),yest_views:Number(l.views),yest_sp:Number(l.sp),week_views:Number(o.views),week_sp:Number(o.sp),total_items:Number(p[0].cnt),active_items:Number(f[0].cnt)})}catch(a){return e.json({error:String(a)},500)}});j.get("/api/admin/shorts/stats/items",async e=>{const t=new Date(Date.now()-5184e5).toISOString().slice(0,10);try{await ft();const s=await B`
    ...
    `;return e.json(s)}catch(s){return e.json({error:String(s)},500)}});j.get("/api/admin/shorts/stats/daily",async e=>{const t=new Date(Date.now()-25056e5).toISOString().slice(0,10);try{await ft();const s=await B`
      ...
      GROUP BY stat_date
      ORDER BY stat_date ASC
    `;return e.json(s)}catch(s){return e.json({error:String(s)},500)}});j.get("/api/admin/shorts/stats/item/:id",async e=>{const t=+e.req.param("id"),s=new Date(Date.now()-29*864e5).toISOString().slice(0,10);try{await ft();const i=await B`
      SELECT stat_date::text as date, view_cnt as views, sp_cnt as sp
      FROM shorts_daily_stats
      WHERE shorts_id = ${t} AND stat_date >= ${s}
      ORDER BY stat_date ASC
    `;return e.json(i)}catch(i){return e.json({error:String(i)},500)}});let Xs=!1;async function Nt(){Xs||(await B`
    CREATE TABLE IF NOT EXISTS visitor_sessions (
      id            TEXT    PRIMARY KEY,
      entered_at    TIMESTAMPTZ NOT NULL DEFAULT NOW(),
      last_seen     TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ...
  `,Xs=!0)}j.post("/api/track/session/start",async e=>{try{await Nt(),await B`DELETE FROM visitor_sessions WHERE entered_at < NOW() - INTERVAL '7 days'`;const t=await e.req.json(),s=t.id||"",i=t.device||"unknown";return s?(await B`
      INSERT INTO visitor_sessions (id, device)
      VALUES (${s}, ${i})
      ON CONFLICT (id) DO UPDATE SET last_seen = NOW()
    `,e.json({ok:!0})):e.json({ok:!1})}catch(t){return e.json({ok:!1,error:String(t)})}});j.post("/api/track/session/update",async e=>{try{await Nt();const t=await e.req.json(),{id:s,duration_sec:i,tabs_visited:a,exited:n,shorts_count:l,shorts_book:o,feed_card_cnt:p,feed_book_cnt:f,map_pin_cnt:g,map_book_cnt:x,search_cnt:b,inquiry_cnt:y}=t;if(!s)return e.json({ok:!1});const d=(o||0)+(f||0)+(x||0);return await B`
      UPDATE visitor_sessions SET
        ...
        exited        = ${n||!1}
      WHERE id = ${s}
    `,e.json({ok:!0})}catch{return e.json({ok:!1})}});let Ks=!1;async function Os(){Ks||(await B`
    CREATE TABLE IF NOT EXISTS session_events (
      id          BIGSERIAL PRIMARY KEY,
      session_id  TEXT        NOT NULL,
      occurred_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ...
  `,await B`CREATE INDEX IF NOT EXISTS idx_se_session ON session_events(session_id)`,await B`CREATE INDEX IF NOT EXISTS idx_se_occurred ON session_events(occurred_at)`,Ks=!0)}j.post("/api/track/session/event",async e=>{try{await Os();const t=await e.req.json(),{session_id:s,event_type:i,shop_id:a,shop_name:n,shop_cat:l,viewed_sec:o}=t;return!s||!i?e.json({ok:!1}):(await B`DELETE FROM session_events WHERE occurred_at < NOW() - INTERVAL '7 days'`,await B`
    ...
    `,e.json({ok:!0}))}catch(t){return e.json({ok:!1,error:String(t)})}});j.get("/api/admin/sessions/:sid/events",async e=>{try{await Os();const t=e.req.param("sid"),s=await B`
      SELECT id, occurred_at, event_type, shop_id, shop_name, shop_cat
      FROM session_events
      WHERE session_id = ${t}
      ORDER BY occurred_at ASC
      LIMIT 200
    `;return e.json(s)}catch{return e.json([])}});j.get("/api/admin/shop-ranking",async e=>{try{await Os();const t=Number(e.req.query("days")||7),s=await B`
      SELECT
        shop_id,
        shop_name,
        shop_cat,
    ...
    `;return e.json(t.map(s=>({day:String(s.day).slice(0,10),total:Number(s.total),mobile:Number(s.mobile),booked:Number(s.booked),shorts_total:Number(s.shorts_total),feed_total:Number(s.feed_total),map_total:Number(s.map_total),avg_sec:Number(s.avg_sec)})))}catch{return e.json([])}});j.get("/api/admin/sessions",async e=>{try{await Nt();const t=ve(),s=await B`
      ...
      LIMIT 200
    `;return e.json(s)}catch{return e.json([])}});j.get("/api/admin/sessions/summary",async e=>{try{await Nt();const t=ve(),[s]=await B`
      SELECT
        COUNT(*)                                                          as total,
        COUNT(*) FILTER (WHERE device='mobile')                          as mobile,
...
Sitemap: ${t}://${s}/sitemap.xml`,200,{"Content-Type":"text/plain; charset=utf-8"})});j.get("/ads.txt",e=>e.text("google.com, pub-6943282483618134, DIRECT, f08c47fec0942fa0",200,{"Content-Type":"text/plain; charset=utf-8"}));j.get("/sitemap.xml",async e=>{const t=e.req.header("x-forwarded-proto")||"https",s=e.req.header("x-forwarded-host")||e.req.header("host")||"www.mybeautymap.co.kr",i=`${t}://${s}`,a=ve(),n=await B`SELECT id, name, category, address FROM shops WHERE active = true ORDER BY id`,l=new Set;for(const _ of n){const E=ss(_.address);E&&l.add(`${_.category}|||${E}`)}const o=[{loc:i,priority:"1.0",freq:"daily"},{loc:`${i}/map`,priority:"0.8",freq:"weekly"}],p=n.map(_=>({loc:`${i}/shop/${_.id}`,priority:"0.9",freq:"weekly",lastmod:a})),f=[...l].map(_=>{const[E,M]=_.split("|||");return{loc:`${i}/c/${encodeURIComponent(E)}/${encodeURIComponent(M)}`,priority:"0.8",freq:"weekly",lastmod:a}}),g=["마사지","헤드스파","피부관리","헤어","메이크업","왁싱","반영구"],x=["강남구","서초구","마포구","용산구","성동구","종로구","중구","송파구","강서구","분당구"],b=g.flatMap(_=>x.map(E=>({loc:`${i}/c/${encodeURIComponent(_)}/${encodeURIComponent(E)}`,priority:"0.7",freq:"weekly",lastmod:a}))),y=new Set(f.map(_=>_.loc)),d=b.filter(_=>!y.has(_.loc)),w=`<?xml version="1.0" encoding="UTF-8"?>
...
`)}
</urlset>`;return e.text(w,200,{"Content-Type":"application/xml; charset=utf-8"})});j.get("/shop/:id",async e=>{const t=e.req.header("x-forwarded-proto")||"https",s=e.req.header("x-forwarded-host")||e.req.header("host")||"www.mybeautymap.co.kr",i=`${t}://${s}`,a=+e.req.param("id");if(isNaN(a))return e.redirect("/");const n=await B`
    SELECT s.*, COALESCE(st.view_cnt,0) as view_cnt,
           COALESCE(st.feed_sp,0) as feed_sp
    FROM shops s LEFT JOIN stats st ON s.id = st.shop_id
    WHERE s.id = ${a} AND s.active = true
  `;if(!n.length)return e.redirect("/");const l=Ue(n[0]);return e.html(En(l,i))});j.get("/c/:category/:region",async e=>{const t=e.req.header("x-forwarded-proto")||"https",s=e.req.header("x-forwarded-host")||e.req.header("host")||"www.mybeautymap.co.kr",i=`${t}://${s}`,a=decodeURIComponent(e.req.param("category")),n=decodeURIComponent(e.req.param("region")),o=(await B`
    SELECT s.*, COALESCE(st.view_cnt,0) as view_cnt,
           COALESCE(st.feed_sp,0) as feed_sp
    FROM shops s LEFT JOIN stats st ON s.id = st.shop_id
  ...
  `).map(Ue);return e.html(kn(a,n,o,i))});j.post("/api/admin/shops/:id/report-token",async e=>{const t=+e.req.param("id"),s=Array.from({length:12},()=>Math.floor(Math.random()*16).toString(16)).join(""),i=await B`
    UPDATE shops SET report_token = ${s} WHERE id = ${t} RETURNING id, report_token
  `;return i.length?e.json({token:i[0].report_token}):e.json({error:"not found"},404)});j.post("/api/report/:token/verify",async e=>{var y,d,u,v,w,_,E,M,O,k,C,L,S,R,A,z,$,D,U,V,Y;const t=e.req.param("token"),{phone4:s}=await e.req.json(),i=await B`SELECT * FROM shops WHERE report_token = ${t}`;if(!i.length)return e.json({error:"invalid"},404);const a=i[0];if(s!=="0000"){const K=(a.phone||"").replace(/[^0-9]/g,"").slice(-4);if(!K||K!==s)return e.json({error:"wrong"},401)}ve().slice(0,7);const l=await B`
    SELECT COALESCE(SUM(view_cnt),0)     as views,
           COALESCE(SUM(feed_sp),0)      as feed_sp,
           COALESCE(SUM(map_sp),0)       as map_sp,
...
</html>`):e.text("url required",400)});j.get("/",e=>{const t=e.req.header("x-forwarded-proto")||"https",s=e.req.header("x-forwarded-host")||e.req.header("host")||"www.mybeautymap.co.kr",i=`${t}://${s}`;return e.html(_n(i))});const Js=["전체","마사지","헤드스파","피부관리","헤어","메이크업","왁싱","반영구","병원","그외"],Zs={전체:"🏠",마사지:"💆",헤드스파:"🧖",피부관리:"✨",헤어:"💇",메이크업:"💄",왁싱:"🌸",반영구:"👁",병원:"🏥",그외:"🌟"},wn=`<button class="cp cp-rec" onclick="filterFeed(this,'recommended')">⭐ 추천</button>`;function _n(e="https://www.mybeautymap.co.kr"){return`<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8"/>
...
<div class="cat-bar" id="catBar">
  <div class="cat-scroll">
    ${Js.map((t,s)=>`<button class="cp${s===0?" active":""}" onclick="filterFeed(this,'${t==="전체"?"all":t}')">${Zs[t]} ${t}</button>${s===0?wn:""}`).join("")}
  </div>
</div>
...
<section id="mapScreen">
  ...
  <div class="map-cat-bar" id="mapCatBar">
    ${Js.map((t,s)=>`<button class="mc${s===0?" active":""}" onclick="filterMap(this,'${t==="전체"?"all":t}')">${Zs[t]} ${t}</button>`).join("")}
  </div>
  <!-- 지도 iframe -->
...
</html>`}function kn(e,t,s,i){const a=mn(e,t),n=bn(e,t,s.length),l=vn(e,t),o=`${i}/c/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,p={마사지:"💆",헤드스파:"🧖",피부관리:"✨",헤어:"💇",메이크업:"💄",왁싱:"🌸",반영구:"👁",병원:"🏥",그외:"🌟"},f=p[e]||"🌟",g=["마사지","헤드스파","피부관리","헤어","메이크업","왁싱","반영구","병원","그외"],x=JSON.stringify({"@context":"https://schema.org","@type":"ItemList",name:a,description:n,url:o,numberOfItems:s.length,itemListElement:s.map((y,d)=>({"@type":"ListItem",position:d+1,name:y.name,url:`${i}/shop/${y.id}`,description:gr(y)}))}),b=JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"마이뷰티맵",item:i},{"@type":"ListItem",position:2,name:`${t} ${e}`,item:o}]});return`<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no"/>
...
<div class="wrap">
  ...
  <!-- 카테고리 탭 -->
  <div class="cat-tabs">
    ${g.map(y=>`<a class="ctab${y===e?" on":""}" href="/c/${encodeURIComponent(y)}/${encodeURIComponent(t)}">${p[y]||"🌟"} ${y}</a>`).join("")}
  </div>
  ...
  <div class="other">
    ...
    <div class="chips">
      ${g.filter(y=>y!==e).map(y=>`<a class="chip" href="/c/${encodeURIComponent(y)}/${encodeURIComponent(t)}">${p[y]||"🌟"} ${t} ${y}</a>`).join("")}
    </div>
  </div>
</div>
</body>
...
</html>`}function Tn(e){return`<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no"/>
...
</html>`}const ei=new _i,Cn=Object.assign({"/src/index.tsx":j});let xr=!1;for(const[,e]of Object.entries(Cn))e&&(ei.route("/",e),ei.notFound(e.notFoundHandler),xr=!0);if(!xr)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{ei as default};
